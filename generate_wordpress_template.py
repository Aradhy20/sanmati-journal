...
<body class="text-slate-800 antialiased min-h-screen">
    ...
    <!-- Header Section -->
    <header class="relative py-8 lg:py-16 bg-gradient-to-br from-[#0F4C81]/10 via-white to-[#2563EB]/5 border-b border-slate-100 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10 text-center">
            <nav class="flex items-center justify-center gap-3 text-[10px] font-bold uppercase tracking-[0.3em] mb-4 text-[#0F4C81]">
                <span>Portal</span>
                <span class="w-1.5 h-1.5 rounded-full bg-[#0F4C81]/20"></span>
                <span>Archive</span>
            </nav>
            <h1 class="text-4xl lg:text-5xl font-bold font-poppins text-slate-900 tracking-tight mb-4">
                Journal Archive
            </h1>
            <div class="flex flex-col items-center gap-3">
                <span class="block h-1 w-12 bg-[#2563EB] mx-auto rounded mb-3"></span>
