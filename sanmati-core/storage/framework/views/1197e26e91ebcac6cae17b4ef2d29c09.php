    ...
    <div class="container">
        ...
        <div class="body">
            <div class="field">
                ...
                <div class="field-value"><?php echo e($enquiryData['firstName']); ?> <?php echo e($enquiryData['lastName']); ?></div>
            </div>
            <div class="field">
                <div class="field-label">Email</div>
                <div class="field-value"><a href="mailto:<?php echo e($enquiryData['email']); ?>"><?php echo e($enquiryData['email']); ?></a></div>
            </div>
            <div class="field">
                <div class="field-label">Subject</div>
                <div class="field-value"><?php echo e($enquiryData['subject']); ?></div>
            </div>
            <div class="field">
                <div class="field-label">Message</div>
                <div class="message-box"><?php echo e($enquiryData['message']); ?></div>
            </div>
        </div>
        <div class="footer">
...
<?php /**PATH /Users/aradhyjain/Desktop/sanmati-journal/resources/views/emails/enquiry-received.blade.php ENDPATH**/ ?>