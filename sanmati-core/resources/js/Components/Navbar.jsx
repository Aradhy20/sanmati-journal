                        ...
                        <div className="pl-2 pr-2 py-1 grid grid-cols-1 gap-1 border-l-2 border-primary/10 ml-6 mt-1 mb-2">
                             {item.dropdown.map((subItem) => (
                                <Link
                                    key={subItem.name}
                                    href={subItem.href}
                                    className={`block px-4 py-3 min-h-[48px] flex items-center text-[13px] rounded-xl transition-colors ${isActive(subItem.href)
            ...
            <nav className={`w-full relative z-40 overflow-x-visible transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] border-b ${scrolled 
                ...
                <div className="container-custom">
                    <div className="flex items-center justify-between h-16 sm:h-[72px] gap-1.5 xl:gap-2 2xl:gap-6">
                        ...
                        <div className="hidden lg:flex items-center justify-center gap-0.5 2xl:gap-1 flex-1 min-w-0 overflow-visible relative">
                            {navItems.map((item) => (
                                <div
                                    key={item.name}
                                ...
                                {navItems.map((item, idx) => (
                                    ...
                                    >
                                        {item.dropdown ? (
                                            ...
                                            <Link
                                                href={item.href}
                                                className={`flex w-full px-4 min-h-[48px] items-center text-sm font-bold rounded-xl transition-colors font-sans uppercase tracking-wider ${isActive(item.href)
