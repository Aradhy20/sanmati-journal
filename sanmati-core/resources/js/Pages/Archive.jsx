...
export default function Archive({ issues }) {
    ...
    // Separate Compilation Issue and Research Volumes
    const researchIssues = useMemo(() => {
        // filter out compilation and order standard volumes numerically
        return dbIssues
            .filter(issue => issue.volume !== '1' || issue.month_range !== 'Jan-Mar')
            .sort((a, b) => {
        ...
        <MainLayout>
            ...
            <div className="min-h-screen bg-[#F8FAFC] py-12 lg:py-20 font-inter text-slate-800">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {/* Spotlight Banner: Full Issue Compilation Book */}
                    {compilationIssue && compilationIssue.papers && compilationIssue.papers[0] && (
                        <motion.div
                        ...
                        >
                            <div className="absolute top-0 right-0 w-96 h-96 bg-white/5 rounded-full blur-[80px] -mr-20 -mt-20 group-hover:bg-white/10 transition-colors duration-500" />
                            <div className="absolute bottom-0 left-0 w-80 h-80 bg-blue-500/10 rounded-full blur-[80px] -ml-20 -mb-20" />
                            
                            <div className="relative z-10 grid lg:grid-cols-12 gap-8 items-center">
                                <div className="lg:col-span-8">
                                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/20 border border-amber-500/30 text-[#F59E0B] text-xs font-black uppercase tracking-wider mb-6">
                                        <Award className="w-4 h-4" /> Full Issue Compilation
                                    </div>
                                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold font-poppins text-white leading-tight mb-4">
                                        {compilationIssue.papers[0].title}
                                    </h2>
                                    <p className="text-blue-100 italic text-sm mb-6 leading-relaxed">
                                        {compilationIssue.papers[0].authors}
                                    </p>
                                    <p className="text-slate-300 text-sm max-w-3xl mb-8 leading-relaxed">
                                        {compilationIssue.papers[0].abstract}
                                    </p>
                                    <div className="flex flex-wrap gap-4">
                                        ...
                                        >
                                            <BookOpen className="w-4 h-4" /> View Full Issue
                                        </a>
                                        <a 
                                            href={compilationIssue.papers[0].file_url} 
                                            target="_blank" 
                                        ...
                                        >
                                            <Download className="w-4 h-4" /> Download Book (83MB)
                                        </a>
                                    </div>
                                </div>
                                <div className="lg:col-span-4 hidden lg:flex justify-end relative">
                                    <div className="w-64 aspect-[3/4] rounded-2xl overflow-hidden bg-slate-900 shadow-2xl border border-white/10 relative transform group-hover:scale-105 transition-transform duration-500">
                                        <img 
                                        ...
                                        />
                                        <div className="hidden absolute inset-0 bg-[#0F4C81] flex-col items-center justify-center p-6 text-center">
                                            <Layers className="w-12 h-12 mb-4 text-amber-500" />
                                            <span className="font-poppins font-bold text-lg text-white">Vol. 1 Issue 1</span>
                                            <span className="text-slate-300 text-xs mt-2 uppercase tracking-widest">Compendium</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
