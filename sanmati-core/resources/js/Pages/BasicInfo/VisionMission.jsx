            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 lg:pb-24">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12">
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                        <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mb-6 text-blue-800">
                            <Compass className="w-8 h-8" />
                        </div>
                        <h2 className="text-xl md:text-2xl lg:text-3xl font-serif font-bold text-dark mb-4">Our Vision</h2>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
                        ...
                        <h2 className="text-xl md:text-2xl lg:text-3xl font-serif font-bold text-dark mb-4">Our Mission</h2>
                        <p className="text-dark/80 leading-relaxed text-lg">
