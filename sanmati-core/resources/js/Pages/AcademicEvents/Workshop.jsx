                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
                                        <ScrollReveal variants={revealVariants.zoom} delay={0.1}>
                                            <div className="group p-8 bg-warm-bg rounded-[32px] border border-gray-200 hover:bg-white hover:shadow-2xl hover:border-blue-300 transition-all duration-300 relative overflow-hidden h-full">
                                                <GridPattern className="opacity-0 group-hover:opacity-5 transition-opacity" />
                                                <div className="relative z-10">
                                                    <div className="w-14 h-14 bg-primary/10 rounded-2xl flex items-center justify-center text-primary mb-6 group-hover:scale-110 transition-transform">
                                                        <BookOpen className="w-7 h-7" />
                                                    </div>
                                                    <h3 className="text-xl font-bold text-dark mb-3">Academic Writing</h3>
                                                    <p className="text-gray-600 text-sm leading-relaxed mb-6">Master the art of structuring research papers and navigating the peer-review process.</p>
                                        ...
                                        <ScrollReveal variants={revealVariants.zoom} delay={0.2}>
                                            <div className="group p-8 bg-warm-bg rounded-[32px] border border-gray-200 hover:bg-white hover:shadow-2xl hover:border-blue-300 transition-all duration-300 relative overflow-hidden h-full">
                                                ...
                                                <div className="relative z-10">
                                                    ...
                                                    <h3 className="text-xl font-bold text-dark mb-3">Data Analysis</h3>
                                                    <p className="text-gray-600 text-sm leading-relaxed mb-6">Comprehensive training on statistical tools and qualitative data analysis software.</p>
                                                    <div className="flex items-center gap-2 text-primary text-xs font-bold uppercase tracking-widest">
                                                        Learn More <ArrowRight className="w-4 h-4" />
                                                    </div>
                                                </div>
                                    ...
                                    <ScrollReveal variants={revealVariants.zoom} delay={0.3}>
                                        <div className="p-10 bg-gradient-to-br from-slate-900 to-blue-900 text-white rounded-[40px] relative overflow-hidden group">
                                            ...
                                            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
                                                ...
                                                <button className="shrink-0 px-8 py-4 bg-white text-dark font-bold rounded-full hover:bg-primary/5 transition-all shadow-xl">
                                                    Register Now
                                                </button>
                                            </div>
                                        </div>
