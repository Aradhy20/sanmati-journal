                    ...
                    <div className="max-w-4xl mx-auto space-y-12 mt-12">
                        ...
                        <ScrollReveal>
                            <section className="text-center mb-16">
                                <p className="text-xl text-dark/80 leading-relaxed font-serif max-w-2xl mx-auto text-dark/80">
                                    ...
                                    <ScrollReveal key={index} delay={index * 0.1} variants={revealVariants.left}>
                                        <div className="relative pl-0 md:pl-24">
                                            ...
                                            <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-100 hover:shadow-xl transition-shadow relative overflow-hidden group">
                                                ...
                                                <h3 className="text-xl font-bold text-dark mb-4 flex items-center gap-3 relative z-10">
                                                ...
                                                {step.type === 'decision' ? (
                                                    <div className="relative z-10">
                                                        <p className="mb-4 text-dark/80">{step.content}</p>
                                                        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm font-bold text-dark">
                                                    ...
                                                    <ul className="list-disc pl-6 space-y-3 text-gray-600 relative z-10">
