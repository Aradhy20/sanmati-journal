        ...
        <AdminLayout>
            <div className="space-y-8">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-xl md:text-2xl lg:text-3xl font-serif font-bold text-dark mb-2">Message Center</h1>
                        <p className="text-gray-500 text-sm">Manage and respond to all editorial enquiries.</p>
                    </div>
                ...
                <div className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-warm-bg/50 border-b border-slate-100">
                                    <th className="px-8 py-5 text-xs font-black text-gray-400 uppercase tracking-widest">Sender</th>
                                    <th className="px-8 py-5 text-xs font-black text-gray-400 uppercase tracking-widest">Subject & Message</th>
                                        ...
                                        <tr key={enquiry.id} className="hover:bg-warm-bg/50 transition-colors group">
                                            <td className="px-8 py-6">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        <p className="font-bold text-dark">{enquiry.first_name} {enquiry.last_name}</p>
                                                        <p className="text-xs text-gray-500 lowercase">{enquiry.email}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="px-8 py-6 max-w-md">
                                                <p className="font-bold text-dark mb-1 truncate">{enquiry.subject}</p>
                    ...
                    <div className="px-8 py-5 bg-warm-bg/50 flex justify-between items-center border-t border-slate-100">
                        <p className="text-xs font-bold text-gray-400 uppercase tracking-widest">Showing {enquiries.length} results</p>
