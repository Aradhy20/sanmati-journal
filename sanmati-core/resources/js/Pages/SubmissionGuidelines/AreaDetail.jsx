        ...
        return (
            <MainLayout>
                ...
                <div className="text-center py-20">
                    ...
                    <Link href="/submission-guidelines/areas" className="text-primary hover:underline mt-4 block">
                        Back to Areas
                    </Link>
                </div>
            </MainLayout>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-12">
                            ...
                            <ScrollReveal variants={revealVariants.fadeUp} delay={0.2}>
                                <h3 className="text-2xl font-bold text-dark mb-8 mt-4">Key Research Topics</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {area.topics.map((topic, i) => (
                                        <div key={i} className="flex items-start gap-4 p-4 rounded-xl bg-white border border-slate-100 hover:border-primary/20 transition-colors shadow-sm group">
                                            ...
                                            <span className="text-dark/80 font-medium group-hover:text-dark transition-colors">
                                                {topic}
                                            </span>
                                        </div>
                                    ))}
                        ...
                        <div className="lg:col-span-1">
                            <div className="sticky top-24 space-y-6">
                                ...
                                <ScrollReveal variants={revealVariants.left} delay={0.3}>
                                    <div className="bg-white p-8 rounded-3xl shadow-xl border border-slate-100 overflow-hidden relative group">
                                        ...
                                        <div className="relative z-10 text-white">
                                            ...
                                            <Link href="/contact" className="block w-full py-3.5 bg-white text-dark rounded-xl font-bold text-center hover:bg-warm-bg transition-colors">
                                                Submit Paper Now
                                            </Link>
                                        </div>
                                    </div>
                                ...
                                {/* Share */}
                                <div className="flex items-center justify-center gap-2 text-gray-400 text-sm font-medium cursor-pointer hover:text-primary transition-colors">
