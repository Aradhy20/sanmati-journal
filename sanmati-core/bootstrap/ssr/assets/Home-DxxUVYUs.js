...
import { M as MainLayout } from "./MainLayout-4-F76doI.js";
import { motion, useInView, animate } from "framer-motion";
import { Link } from "@inertiajs/react";
import { Globe, ShieldCheck, BookOpen, Award, FileText, ExternalLink, Clock, CheckCircle, BookMarked, Search, Database, ArrowRight, Star, Users, Heart, ArrowUpRight, Microscope, Palette, Calculator, Scale, GraduationCap, Cpu, Feather, Quote, ChevronRight } from "lucide-react";
import "react-hot-toast";
const Hero = React.lazy(() => import("./Hero-nBQi4T-G.js"));
  ...
  return /* @__PURE__ */ jsxs(
    MainLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("section", { className: "py-8 bg-white border-b border-slate-100", children: /* @__PURE__ */ jsx("div", { className: "container-custom", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center justify-center gap-6 md:gap-12 opacity-70", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(ShieldCheck, { className: "w-5 h-5 text-secondary" }),
            /* @__PURE__ */ jsx("span", { className: "font-bold text-xs uppercase tracking-widest text-primary", children: "Peer-Reviewed" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(BookOpen, { className: "w-5 h-5 text-secondary" }),
            /* @__PURE__ */ jsx("span", { className: "font-bold text-xs uppercase tracking-widest text-primary", children: "Google Scholar Indexed" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Globe, { className: "w-5 h-5 text-secondary" }),
            /* @__PURE__ */ jsx("span", { className: "font-bold text-xs uppercase tracking-widest text-primary", children: "CrossRef DOI Indexed" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Award, { className: "w-5 h-5 text-secondary" }),
            /* @__PURE__ */ jsx("span", { className: "font-bold text-xs uppercase tracking-widest text-primary", children: "COPE Ethics Compliant" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(FileText, { className: "w-5 h-5 text-secondary" }),
            /* @__PURE__ */ jsx("span", { className: "font-bold text-xs uppercase tracking-widest text-primary", children: "ISSN 3108-1819" })
          ] })
        ] }) }) }),
        /* @__PURE__ */ jsx("section", { className: "py-10 bg-slate-50 border-b border-slate-100", children: /* @__PURE__ */ jsx("div", { className: "container-custom", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4", children: [
          ...
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: `w-10 h-10 rounded-xl ${item.bg} flex items-center justify-center mb-3`, children: /* @__PURE__ */ jsx(item.icon, { className: `w-5 h-5 ${item.color}` }) }),
              /* @__PURE__ */ jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-slate-400 mb-1", children: item.label }),
              /* @__PURE__ */ jsx("p", { className: `font-bold text-sm ${item.color} leading-snug`, children: item.value })
            ]
          },
          i
        )) }) }) }),
        /* @__PURE__ */ jsx("section", { className: "py-8 bg-white border-b border-slate-100", children: /* @__PURE__ */ jsxs("div", { className: "container-custom", children: [
          /* @__PURE__ */ jsx("div", { className: "text-center mb-6", children: /* @__PURE__ */ jsx("p", { className: "text-[9px] font-black uppercase tracking-[0.3em] text-slate-400", children: "Indexed & Abstracted In" }) }),
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap items-center justify-center gap-4 md:gap-8", children: [
            ...
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsx(db.icon, { className: "w-4 h-4 text-slate-400 group-hover:text-secondary transition-colors" }),
                /* @__PURE__ */ jsx("span", { className: "text-xs font-black uppercase tracking-wider text-slate-600 group-hover:text-primary transition-colors", children: db.name })
              ]
            },
            i
          )) })
        ...
        /* @__PURE__ */ jsx("section", { className: "py-10 bg-secondary/5 border-y border-secondary/10", children: /* @__PURE__ */ jsx("div", { className: "container-custom", children: /* @__PURE__ */ jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-5", children: [
                /* @__PURE__ */ jsx("div", { className: "w-14 h-14 rounded-2xl bg-primary flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(Globe, { className: "w-6 h-6 text-secondary" }) }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("span", { className: "inline-block px-3 py-1 bg-secondary/10 text-secondary text-[9px] font-black uppercase tracking-widest rounded-full mb-2", children: "Upcoming · 5 June 2026" }),
                  /* @__PURE__ */ jsx("h3", { className: "text-lg font-serif font-bold text-primary leading-snug", children: "अंतरराष्ट्रीय सेमिनार एवं रिसर्च एक्सीलेंस अवार्ड" }),
                  /* @__PURE__ */ jsx("p", { className: "text-slate-500 text-xs font-medium mt-1", children: "SERFI · Hybrid Mode · ISSN Publication with DOI · Registration Free" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs(
                Link,
        ...
        /* @__PURE__ */ jsx("section", { className: "py-12 lg:py-16 bg-warm-bg", children: /* @__PURE__ */ jsxs("div", { className: "container-custom", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row justify-between items-end mb-10 gap-6", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-10", children: [
            ...
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "relative aspect-[3/4] rounded-[2rem] overflow-hidden shadow-ambient hover:shadow-ambient-lg transition-all duration-700 mb-6 shrink-0", children: [
                  /* @__PURE__ */ jsx("img", { src: book.img, alt: book.title, className: "w-full h-full object-cover scale-[1.01] group-hover:scale-105 transition-transform duration-[1.5s]", loading: "lazy", decoding: "async" }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "px-2 flex-grow flex flex-col", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-slate-500 text-[13px] leading-relaxed line-clamp-2 mt-auto", children: book.excerpt })
                ] })
              ]
            },
            i
        ...
        /* @__PURE__ */ jsx("section", { className: "py-16 lg:py-24 bg-white relative border-y border-slate-100", children: /* @__PURE__ */ jsxs("div", { className: "container-custom", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: (featuredPapers.length > 0 ? featuredPapers.slice(0, 3) : [
            ...
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-8", children: [
                  /* @__PURE__ */ jsx("span", { className: "font-serif text-4xl font-black text-slate-100 group-hover:text-secondary/10 transition-colors duration-500", children: String(i + 1).padStart(2, "0") }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                    /* @__PURE__ */ jsx("span", { className: "px-2 py-1 rounded-md bg-slate-50 border border-slate-100 text-[9px] font-black text-slate-500 uppercase tracking-wider", children: paper.tag || (i === 0 ? "Featured" : i === 1 ? "Trending" : "Recommended") }),
                    /* @__PURE__ */ jsx(
                      "button",
                      {
                        onClick: (e) => {
                ...
                /* @__PURE__ */ jsx("span", { className: "text-[9px] font-black uppercase tracking-widest text-secondary mb-3", children: paper.category || paper.field || "Research" }),
                ...
                /* @__PURE__ */ jsxs("div", { className: "mt-auto pt-5 border-t border-slate-100 flex items-center justify-between", children: [
                  ...
                  paper.id ? /* @__PURE__ */ jsxs(Link, { href: `/article/${paper.id}`, className: "text-[10px] font-black uppercase tracking-widest text-primary flex items-center gap-1 group/arrow", children: [
                    "Read ",
        ...
        /* @__PURE__ */ jsxs("section", { className: "py-16 lg:py-24 bg-white relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "container-custom relative z-10", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto", children: [
              /* @__PURE__ */ jsxs(motion.div, { ...fadeInUp, className: "group bg-slate-50 rounded-[2.5rem] p-8 border border-slate-100 flex flex-col sm:flex-row gap-8 items-center sm:items-start hover:bg-white hover:shadow-ambient-lg transition-all duration-700 h-full", children: [
                /* @__PURE__ */ jsx("div", { className: "w-32 h-32 rounded-[2rem] overflow-hidden shadow-lg shrink-0 border-4 border-white", children: /* @__PURE__ */ jsxs("picture", { children: [
                  ...
                  /* @__PURE__ */ jsx("img", { src: "/mam.jpeg", alt: "Dr Namrata Jain", className: "w-full h-full object-cover object-top group-hover:scale-110 transition-transform duration-1000", loading: "lazy", decoding: "async" })
                ] }) }),
              ...
              /* @__PURE__ */ jsxs(motion.div, { ...fadeInUp, transition: { delay: 0.15 }, className: "group bg-slate-50 rounded-[2.5rem] p-8 border border-slate-100 flex flex-col sm:flex-row gap-8 items-center sm:items-start hover:bg-white hover:shadow-ambient-lg transition-all duration-700 h-full", children: [
                /* @__PURE__ */ jsx("div", { className: "w-32 h-32 rounded-[2rem] overflow-hidden shadow-lg shrink-0 border-4 border-white", children: /* @__PURE__ */ jsxs("picture", { children: [
                  /* @__PURE__ */ jsx("source", { srcSet: "/sir.webp", type: "image/webp" }),
                  /* @__PURE__ */ jsx("img", { src: "/sir.jpeg", alt: "Dr. Ratnesh Kumar Jain", className: "w-full h-full object-cover object-top group-hover:scale-110 transition-transform duration-1000", loading: "lazy", decoding: "async" })
                ] }) }),
                /* @__PURE__ */ jsxs("div", { className: "flex-1 text-center sm:text-left", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center sm:justify-start gap-2 mb-2 text-secondary", children: [
                    /* @__PURE__ */ jsx(Quote, { className: "w-3 h-3 fill-secondary opacity-50" }),
        ...
        currentIssue && /* @__PURE__ */ jsx("section", { className: "py-12 bg-slate-50 border-y border-slate-100", children: /* @__PURE__ */ jsx("div", { className: "container-custom", children: /* @__PURE__ */ jsxs(
          motion.div,
          {
            initial: { opacity: 0, y: 20 },
            whileInView: { opacity: 1, y: 0 },
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-6", children: [
                /* @__PURE__ */ jsx("div", { className: "w-16 h-16 rounded-2xl bg-primary flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(BookOpen, { className: "w-7 h-7 text-secondary" }) }),
                /* @__PURE__ */ jsxs("div", { children: [
                  /* @__PURE__ */ jsx("span", { className: "inline-block px-3 py-1 bg-secondary/10 text-secondary text-[9px] font-black uppercase tracking-widest rounded-full mb-2", children: "Current Issue" }),
                  /* @__PURE__ */ jsxs("h3", { className: "text-xl font-serif font-bold text-primary leading-snug", children: [
                    "Volume ",
                    currentIssue.volume,
                    ", Issue ",
                    currentIssue.number,
                  ...
                  /* @__PURE__ */ jsxs("p", { className: "text-slate-500 text-sm font-medium mt-1", children: [
                    ((_a = currentIssue.papers) == null ? void 0 : _a.length) || 0,
                    " Research Papers · Open Access · DOI Registered"
                  ] })
                ] })
              ] }),
        ...
        /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx("div", { className: "h-48 bg-white" }), children: /* @__PURE__ */ jsx(HomeFAQ, {}) }),
        ...
        /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx("div", { className: "h-40 bg-primary" }), children: /* @__PURE__ */ jsx(NewsletterSection, {}) })
      ]
    }
  );
}
