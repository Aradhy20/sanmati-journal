...
function Contact() {
  return /* @__PURE__ */ jsxs(MainLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("section", { className: "max-w-7xl mx-auto px-6 -mt-16 relative z-20 mb-10 lg:mb-20", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative rounded-[2.5rem] overflow-hidden shadow-2xl bg-dark", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "absolute inset-x-0 bottom-0 p-10 bg-gradient-to-t from-dark/90 via-dark/40 to-transparent", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-full border border-white/10 overflow-hidden", children: /* @__PURE__ */ jsx("img", { loading: "lazy", src: "/images/contact/dr_namrta_jain_avatar.png", alt: "Dr Namrata Jain", className: "w-full h-full object-cover" }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-white font-bold text-sm leading-none mb-1", children: "Dr Namrata Jain" }),
                /* @__PURE__ */ jsx("p", { className: "text-white/30 text-[10px] uppercase font-black tracking-widest leading-none", children: "President & Editor-in-Chief" })
              ] })
            ] })
          ] })
        ] })
