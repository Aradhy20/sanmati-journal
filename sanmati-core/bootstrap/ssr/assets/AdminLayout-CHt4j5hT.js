...
function AdminLayout({ children }) {
  ...
  const links = [
    ...
    { href: "/admin/testimonials", label: "Testimonials", icon: MessageCircle, color: "from-amber-400 to-orange-500" },
    ...
    /* @__PURE__ */ jsxs("aside", { className: "w-80 bg-white border-r border-slate-200/60 fixed h-screen flex flex-col z-50 shadow-[4px_0_24px_rgba(0,0,0,0.02)]", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "p-6 mt-auto", children: /* @__PURE__ */ jsxs("div", { className: "bg-slate-50 rounded-3xl p-4 border border-slate-100 flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-blue-600 font-bold shadow-sm", children: (user.full_name || "A").charAt(0) }),
          /* @__PURE__ */ jsxs("div", { className: "flex-grow min-w-0", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-slate-900 truncate", children: user.full_name || "Admin User" }),
