              ...
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "text-center lg:text-left", children: [
                    ...
                    /* @__PURE__ */ jsx("p", { className: "text-[10px] uppercase font-black text-slate-600 tracking-wider", children: "Papers" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "text-center lg:text-left border-x border-slate-200/60", children: [
                    ...
                    /* @__PURE__ */ jsx("p", { className: "text-[10px] uppercase font-black text-slate-600 tracking-wider", children: "Citations" })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "text-center lg:text-left", children: [
                    /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-primary", children: "Fast" }),
                    /* @__PURE__ */ jsx("p", { className: "text-[10px] uppercase font-black text-slate-600 tracking-wider", children: "Review" })
                  ] })
                ]
              }
            )
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-600 flex-shrink-0", children: /* @__PURE__ */ jsx(ShieldCheck, { className: "w-4 h-4 sm:w-5 sm:h-5" }) }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "text-[11px] sm:text-sm font-black text-primary leading-none", children: "Crossref" }),
                    /* @__PURE__ */ jsx("p", { className: "text-[8px] sm:text-[9px] font-bold text-slate-500 mt-0.5 sm:mt-1 uppercase", children: "DOI Indexed" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-amber-50 flex items-center justify-center text-amber-600 flex-shrink-0", children: /* @__PURE__ */ jsx(Trophy, { className: "w-4 h-4 sm:w-5 sm:h-5" }) }),
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "text-[11px] sm:text-sm font-black text-primary leading-none", children: "5.3 Impact Factor" }),
                    /* @__PURE__ */ jsx("p", { className: "text-[8px] sm:text-[9px] font-bold text-slate-500 mt-0.5 sm:mt-1 uppercase", children: "CrossRef Evaluation" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[115%] h-[115%] border border-slate-200 rounded-full pointer-events-none z-0 opacity-60 hidden md:block" }),
            /* @__PURE__ */ jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[130%] h-[130%] border border-slate-200/50 rounded-full border-dashed pointer-events-none z-0 opacity-40 animate-[spin_60s_linear_infinite] hidden lg:block will-change-transform" })
          ]
        }
      ) })
    ] }) }),
    /* @__PURE__ */ jsx("div", { className: "w-full relative z-20 mt-auto border-t border-slate-200/60 bg-white/50 backdrop-blur-sm", children: /* @__PURE__ */ jsx("div", { className: "container-custom py-6", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-center md:justify-between items-center gap-6 opacity-80 grayscale hover:grayscale-0 transition-all duration-500 cursor-default", children: [
      ...
      /* @__PURE__ */ jsxs(
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsx(Microscope, { className: "w-5 h-5 text-primary group-hover:text-secondary" }),
