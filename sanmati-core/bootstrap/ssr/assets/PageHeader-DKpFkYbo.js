...
const PageHeader = ({ title, breadcrumb, subtitle }) => {
  return /* @__PURE__ */ jsxs("section", { className: "relative py-8 md:py-12 lg:py-16 overflow-hidden bg-warm-bg", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-6 relative z-10", children: /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("nav", { className: "flex items-center justify-center gap-3 text-[10px] font-black uppercase tracking-[0.3em] mb-6", children: [
          ...
          /* @__PURE__ */ jsx("h1", { className: "text-3xl md:text-4xl lg:text-5xl md:text-5xl lg:text-6xl font-serif font-bold text-dark mb-4 tracking-tight", children: title }),
