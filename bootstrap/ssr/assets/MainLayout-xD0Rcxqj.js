...
const Navbar = () => {
  ...
  new Date((/* @__PURE__ */ new Date()).getFullYear(), (/* @__PURE__ */ new Date()).getMonth() + 1, 0, 23, 59, 59).toISOString();
  const { url } = usePage();
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("nav", { className: `sticky top-0 w-full z-40 transition-all duration-500 ease-[0.22,1,0.36,1] ${scrolled ? "bg-white/80 backdrop-blur-2xl shadow-sm border-b border-gray-100/50 py-1" : "bg-white/95 border-b border-transparent py-4"}`, children: [
