...
function CallForPapers() {
  ...
  return /* @__PURE__ */ jsx(MainLayout, { children: /* @__PURE__ */ jsxs("div", { className: "bg-[#eef1ff] min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-24 relative", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-white rounded-[2rem] shadow-xl border border-gray-100 relative", children: /* @__PURE__ */ jsxs("div", { className: "p-8 md:p-12", children: [
        ...
        step < 4 && /* @__PURE__ */ jsx("form", { onSubmit: handleSubmit, encType: "multipart/form-data", children: /* @__PURE__ */ jsxs(AnimatePresence, { mode: "wait", children: [
