...
const Hero = React.lazy(() => import("./Hero-fAvub8r9.js"));
const fadeInUp = {
  initial: { opacity: 0, y: 20 },
  whileInView: { opacity: 1, y: 0 },
  ...
  return /* @__PURE__ */ jsxs(
    MainLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("section", { className: "py-10 bg-white border-y border-gray-100 relative z-20 shadow-sm", children: /* @__PURE__ */ jsx("div", { className: "container-custom", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-8", children: [
          /* @__PURE__ */ jsxs("div", { className: "shrink-0 text-center md:text-left", children: [
            /* @__PURE__ */ jsx("p", { className: "text-secondary font-black text-[10px] uppercase tracking-[0.3em] mb-1", children: "Globally Recognized" }),
            /* @__PURE__ */ jsx("h3", { className: "text-dark font-serif font-bold text-lg", children: "Indexed & Trusted By" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex-grow flex flex-wrap justify-center md:justify-end items-center gap-6 sm:gap-10 opacity-70 grayscale hover:grayscale-0 transition-all duration-500", children: [
            { name: "UGC CARE", icon: "🇮🇳" },
            { name: "Google Scholar", icon: "🎓" },
            { name: "CrossRef DOI", icon: "🔗" },
            { name: "Open Access", icon: "🔓" },
            { name: "Blind Peer Review", icon: "👁️‍🗨️" }
          ].map((badge, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 group cursor-default", children: [
            /* @__PURE__ */ jsx("span", { className: "text-2xl group-hover:scale-110 transition-transform", children: badge.icon }),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-dark-light whitespace-nowrap", children: badge.name })
          ] }, i)) })
        ] }) }) }),
          ...
          /* @__PURE__ */ jsx("div", { className: "container-custom", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-20 items-center", children: [
            ...
            /* @__PURE__ */ jsxs(motion.div, { ...fadeInUp, className: "relative z-10", children: [
              ...
              /* @__PURE__ */ jsxs("h2", { className: "text-2xl md:text-3xl lg:text-4xl lg:text-5xl font-serif font-bold text-dark leading-[1.1] mb-8", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "text-primary italic", children: "Spectrum of Knowledge" })
              ] }),
              /* @__PURE__ */ jsx("p", { className: "text-muted leading-relaxed text-lg mb-10 border-l-2 border-primary/15 pl-8", children: "Sanmati Spectrum is India's rising multidisciplinary beacon, dedicating to bridging the gap between traditional intellectual rigor and modern scientific discourse. We celebrate original research and book publications alike." }),
        ...
        /* @__PURE__ */ jsx("section", { className: "py-32 bg-warm-bg", children: /* @__PURE__ */ jsxs("div", { className: "container-custom", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white p-6 rounded-[2rem] shadow-sm border border-gray-100 flex flex-col md:flex-row gap-4 mb-12", children: [
            ...
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "h-56 overflow-hidden relative", children: [
                  ...
                  book.badge && /* @__PURE__ */ jsx("span", { className: "absolute top-4 left-4 bg-secondary text-white text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded-full shadow-lg", children: book.badge })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "p-8 flex flex-col flex-grow", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-muted text-[11px] font-bold mb-4", children: book.format }),
                  /* @__PURE__ */ jsx("h3", { className: "text-xl font-serif font-bold text-dark mb-4 group-hover:text-primary transition-colors leading-tight", children: book.title }),
                  /* @__PURE__ */ jsx("p", { className: "text-muted text-sm leading-relaxed mb-6 flex-grow", children: book.excerpt }),
                  /* @__PURE__ */ jsxs(Link, { href: "/book-publication", className: "inline-flex items-center justify-center gap-2 w-full py-3.5 bg-primary/8 text-primary rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-primary hover:text-white transition-all group/btn", children: [
                    book.price,
                    " ",
        ...
        /* @__PURE__ */ jsx("section", { className: "py-32 bg-white relative", children: /* @__PURE__ */ jsxs("div", { className: "container-custom", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 max-w-5xl mx-auto", children: [
            /* @__PURE__ */ jsx(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, className: "group", children: /* @__PURE__ */ jsxs("div", { className: "h-full rounded-[3rem] overflow-hidden bg-gradient-to-br from-primary to-primary-dark text-white p-10 flex flex-col items-center text-center shadow-2xl hover:-translate-y-2 transition-all duration-700 relative", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "w-44 h-44 rounded-[2.5rem] overflow-hidden mb-8 border-4 border-white/30 shadow-2xl relative z-10", children: /* @__PURE__ */ jsx("img", { loading: "lazy", src: "/mam.jpeg", alt: "Dr. Namrta Jain", className: "w-full h-full object-cover object-top group-hover:scale-110 transition-all duration-700" }) }),
              ...
              /* @__PURE__ */ jsx("p", { className: "text-white/70 text-[12px] font-bold uppercase tracking-[0.05em] mb-2", children: "Sanmati Spectrum of Knowledge & Emerging Discourse" }),
              /* @__PURE__ */ jsx("p", { className: "text-white/40 text-[10px] uppercase font-black tracking-widest mb-6 min-h-[15px]" }),
            ...
            /* @__PURE__ */ jsx(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { delay: 0.15 }, className: "group", children: /* @__PURE__ */ jsxs("div", { className: "h-full rounded-[3rem] overflow-hidden bg-surface border border-gray-100 p-10 flex flex-col items-center text-center shadow-lg hover:shadow-2xl hover:border-primary/20 hover:-translate-y-2 transition-all duration-700 relative", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-muted text-[12px] font-bold uppercase tracking-wider mb-2 min-h-[18px]" }),
              /* @__PURE__ */ jsx("p", { className: "text-dark/40 text-[10px] uppercase font-black tracking-widest mb-6 min-h-[15px]" }),
        ...
        /* @__PURE__ */ jsxs("section", { className: "py-32 bg-white relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "container-custom relative z-10", children: [
            /* @__PURE__ */ jsxs("div", { className: "text-center max-w-3xl mx-auto mb-10 lg:mb-20", children: [
              ...
              /* @__PURE__ */ jsxs(motion.h2, { ...fadeInUp, transition: { delay: 0.1 }, className: "text-2xl md:text-3xl lg:text-4xl lg:text-5xl font-serif font-bold text-dark mb-6", children: [
                "Explore ",
                /* @__PURE__ */ jsx("span", { className: "text-primary italic", children: "Intellectual Domains" })
              ] }),
              /* @__PURE__ */ jsx(motion.p, { ...fadeInUp, transition: { delay: 0.2 }, className: "text-muted font-medium text-lg leading-relaxed", children: "We publish books and papers across the full spectrum of modern and traditional scholarly inquiry." })
            ] }),
            /* @__PURE__ */ jsx(
              motion.div,
              {
                ...
                children: [
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsx("div", { className: `w-20 h-20 rounded-[1.75rem] ${cat.color} flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-primary group-hover:text-white transition-all duration-500 shadow-sm`, children: /* @__PURE__ */ jsx(cat.icon, { className: "w-9 h-9" }) }),
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "mt-auto pt-4 flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-muted", children: [
        ...
        /* @__PURE__ */ jsx("section", { className: "py-32 bg-white relative overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "container-custom", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-20 items-center", children: [
          /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxs("div", { className: "rounded-[3rem] overflow-hidden shadow-2xl aspect-[4/5] relative", children: [
          ...
          /* @__PURE__ */ jsxs(motion.div, { ...fadeInUp, children: [
            ...
            /* @__PURE__ */ jsx("p", { className: "text-muted font-medium text-lg leading-relaxed mb-12", children: "We deliver world-class book publishing services — from manuscript review and design to global distribution. Every title we publish carries the stamp of academic integrity and premium production quality." }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12", children: [
        ...
        /* @__PURE__ */ jsxs("section", { className: "py-32 bg-warm-bg relative overflow-hidden", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-[600px] h-[600px] bg-primary/5 rounded-full blur-[140px] -mr-96 -mt-96" }),
          /* @__PURE__ */ jsxs("div", { className: "container-custom relative z-10", children: [
            /* @__PURE__ */ jsxs("div", { className: "text-center max-w-3xl mx-auto mb-12 lg:mb-24", children: [
              /* @__PURE__ */ jsxs(motion.div, { ...fadeInUp, className: "flex items-center justify-center gap-4 mb-6", children: [
                /* @__PURE__ */ jsx("span", { className: "h-px w-10 bg-secondary" }),
              ...
              /* @__PURE__ */ jsx(motion.p, { ...fadeInUp, transition: { delay: 0.2 }, className: "text-muted font-medium text-lg", children: "From your manuscript to a published masterpiece — a transparent, rigorous process." })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4 relative", children: [
              /* @__PURE__ */ jsx("div", { className: "hidden md:block absolute top-[60px] left-[10%] right-[10%] h-px bg-gradient-to-r from-transparent via-primary/15 to-transparent" }),
              [
                ...
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxs("div", { className: "z-10 w-28 h-28 rounded-full bg-white border border-gray-100 flex items-center justify-center mb-8 group-hover:bg-primary group-hover:border-primary transition-all duration-500 shadow-xl", children: [
                      ...
                      /* @__PURE__ */ jsx(item.icon, { className: "w-10 h-10 text-secondary group-hover:text-white transition-colors" })
                    ] }),
                    /* @__PURE__ */ jsx("h3", { className: "text-lg font-serif font-bold text-dark mb-4 group-hover:text-primary transition-colors", children: item.title }),
                    /* @__PURE__ */ jsx("p", { className: "text-muted text-[13px] leading-relaxed font-medium", children: item.desc })
                  ]
                },
                i
        ...
        /* @__PURE__ */ jsx("section", { className: "py-12 lg:py-24", children: /* @__PURE__ */ jsx("div", { className: "container-custom", children: /* @__PURE__ */ jsxs("div", { className: "relative rounded-[3.5rem] bg-gradient-to-br from-primary via-primary-dark to-[#0a0f2e] p-14 lg:p-24 overflow-hidden text-center shadow-[0_50px_100px_rgba(79,119,255,0.25)]", children: [
