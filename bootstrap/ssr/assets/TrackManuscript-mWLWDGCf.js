        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-8", children: [
              /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-2xl bg-secondary/10 flex items-center justify-center", children: /* @__PURE__ */ jsx(Search, { className: "w-6 h-6 text-secondary" }) }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("h2", { className: "text-xl font-serif font-bold text-primary", children: "Submission Lookup" }),
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-10", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                ...
                /* @__PURE__ */ jsx("h3", { className: "text-xl font-serif font-bold text-primary", children: "Currently Under Review" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "absolute top-8 left-0 h-0.5 bg-secondary mx-[5%]", style: { width: "30%" } }),
              /* @__PURE__ */ jsx("div", { className: "grid grid-cols-5 gap-2 relative z-10", children: PIPELINE_STAGES.map((stage, i) => {
                ...
                return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center text-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: `text-[10px] font-black uppercase tracking-wider leading-tight ${isActive ? "text-primary" : "text-gray-300"}`, children: stage.label }),
                  isCurrent && /* @__PURE__ */ jsx("span", { className: "bg-secondary text-white text-[8px] font-black px-2 py-0.5 rounded-full uppercase tracking-widest", children: "Current" })
                ] }, stage.key);
              }) })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mt-10 p-5 bg-slate-50 rounded-2xl border border-slate-100 flex gap-4", children: [
              /* @__PURE__ */ jsx(AlertCircle, { className: "w-5 h-5 text-secondary shrink-0 mt-0.5" }),
              /* @__PURE__ */ jsxs("p", { className: "text-sm text-slate-600 font-medium leading-relaxed", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 mt-8", children: [
        ...
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("h4", { className: "font-bold text-primary mb-2", children: card.title }),
