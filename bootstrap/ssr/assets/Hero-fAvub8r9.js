...
import { Sparkles, ArrowRight, BookOpen, BookMarked, CheckCircle, Clock, Star, Users, Globe } from "lucide-react";
const Hero = () => {
  const [daysLeft, setDaysLeft] = useState(0);
  useEffect(() => {
    const now = /* @__PURE__ */ new Date();
    const eom = new Date(now.getFullYear(), now.getMonth() + 1, 0);
    setDaysLeft(Math.ceil((eom - now) / (1e3 * 60 * 60 * 24)));
  }, []);
      ...
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-3 pt-8 border-t border-[#687EFF]/15", children: [
            ...
            ].map((item, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 bg-white/80 backdrop-blur-sm px-4 py-2.5 rounded-xl border border-[#687EFF]/15 shadow-sm", children: [
              /* @__PURE__ */ jsx(item.icon, { className: `w-4 h-4 flex-shrink-0 ${item.color}` }),
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-[#052143] text-[10px] font-black uppercase tracking-widest leading-none mb-0.5", children: item.label }),
                /* @__PURE__ */ jsx("p", { className: "text-[#6B778B] text-[11px] font-bold", children: item.value })
              ] })
            ] }, i)) })
          ]
        }
