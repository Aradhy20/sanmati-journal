...
function Archive({ issues }) {
  ...
  const filteredIssues = useMemo(() => {
    let result = issueList.map((issue) => {
      ...
      const filteredDocs = (issue.papers || []).filter(
        (p) => {
          var _a, _b;
          return ((_a = p.title) == null ? void 0 : _a.toLowerCase().includes(q)) || ((_b = p.authors) == null ? void 0 : _b.toLowerCase().includes(q));
        }
      );
  ...
  return /* @__PURE__ */ jsxs(MainLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-24 relative", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-8 mb-10 lg:mb-20", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative w-full md:w-96 flex gap-2", children: [
      ...
      isLoading ? /* @__PURE__ */ jsx(SkeletonGrid, { count: 4, cols: "2", className: "mt-4" }) : filteredIssues.length > 0 ? /* @__PURE__ */ jsxs("div", { className: "space-y-20", children: [
        !searchQuery && featuredPapers.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mb-16", children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-xl font-bold font-serif mb-6 flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("span", { className: "w-2 h-2 rounded-full bg-primary animate-pulse" }),
            "Featured Research Highlights"
          ] }),
          /* @__PURE__ */ jsx("div", { className: "flex overflow-x-auto gap-6 pb-6 snap-x hide-scrollbar", children: featuredPapers.map((fp, i) => /* @__PURE__ */ jsxs("div", { className: "min-w-[320px] md:min-w-[400px] snap-start bg-white border border-gray-100 p-6 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300", children: [
            /* @__PURE__ */ jsxs("div", { className: "text-[10px] font-black uppercase tracking-widest text-secondary mb-3 flex justify-between", children: [
              /* @__PURE__ */ jsx("span", { children: "Featured Article" }),
              /* @__PURE__ */ jsx("span", { children: "12 Min Read" })
            ] }),
            /* @__PURE__ */ jsx("h4", { className: "font-bold text-dark text-lg mb-2 line-clamp-2", children: fp.title }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-muted italic mb-4 line-clamp-1", children: fp.authors }),
            /* @__PURE__ */ jsxs("a", { href: fp.file_path, target: "_blank", rel: "noopener noreferrer", className: "text-primary font-bold text-sm flex items-center gap-1 hover:underline", children: [
              "Read Now ",
                    ...
                    motion.div,
                    {
                      ...
                      children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-6", children: [
                        /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                          ...
                          /* @__PURE__ */ jsx("p", { className: "text-muted font-medium italic text-sm mb-2", children: paper.authors }),
                          paper.doi && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-primary font-bold text-[10px] uppercase tracking-widest bg-primary/5 px-3 py-1 rounded-full w-fit", children: [
                            /* @__PURE__ */ jsx("span", { className: "opacity-60 text-dark", children: "DOI:" }),
