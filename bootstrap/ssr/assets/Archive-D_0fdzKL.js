...
import { Archive as Archive$1, Search, Calendar, Layers, FileText, BookOpen, Quote, Download } from "lucide-react";
...
function Archive({ issues }) {
  ...
  const issueList = Array.isArray(issues) ? issues : (issues == null ? void 0 : issues.data) || [];
          ...
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-10", children: [
                /* @__PURE__ */ jsx("div", { className: "lg:col-span-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-surface border border-gray-100 p-8 rounded-[2.5rem] sticky top-32 shadow-sm", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[10px] font-black uppercase tracking-widest text-secondary block mb-4", children: "Current Issue" }),
                  /* @__PURE__ */ jsxs("h3", { className: "text-xl md:text-2xl lg:text-3xl font-serif font-bold text-dark mb-6", children: [
                    "Issue No. ",
                    issue.number
                  ] }),
                  /* @__PURE__ */ jsx("p", { className: "text-muted text-sm leading-relaxed mb-8", children: "This issue features a compilation of peer-reviewed research and analytical discourse focusing on emergent multidisciplinary themes." }),
                  ...
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-6", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                        ...
                        /* @__PURE__ */ jsx(Link, { href: `/article/${paper.id}`, className: "block", children: /* @__PURE__ */ jsx("h4", { className: "text-xl font-bold text-dark mb-3 group-hover:text-primary transition-colors leading-[1.4]", children: paper.title }) }),
                        /* @__PURE__ */ jsx("p", { className: "text-muted font-medium italic text-sm", children: paper.authors })
                      ] }),
                      /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center gap-3 mt-4 md:mt-0", children: [
                        /* @__PURE__ */ jsxs(
                          Link,
                          {
