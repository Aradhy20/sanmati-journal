...
const Hero = () => {
  return /* @__PURE__ */ jsxs("section", { className: "relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-[#eef1ff] via-[#f5f0ff] to-[#fff0f5]", children: [
    /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 z-0 pointer-events-none overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "absolute top-1/2 left-1/2 w-[200px] h-[200px] sm:w-[300px] sm:h-[300px] lg:w-[400px] lg:h-[400px] bg-primary/6 rounded-full blur-[100px]" })
    ] }),
    /* @__PURE__ */ jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsx("div", { className: "relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 pt-32 pb-24 lg:pt-36 lg:pb-28", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-start", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-2 px-5 py-2 bg-primary/10 border border-primary/25 rounded-full mb-6", children: [
              /* @__PURE__ */ jsx(Sparkles, { className: "w-3.5 h-3.5 text-primary" }),
              /* @__PURE__ */ jsx("span", { className: "text-primary font-black text-[11px] uppercase tracking-[0.35em]", children: "ISSN: 3108-1819 · Peer-Reviewed Journal" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-secondary font-bold text-base mb-3 font-sans", lang: "hi", children: "ज्ञान, शोध और प्रकाशन का एक राष्ट्रीय मंच" }),
            /* @__PURE__ */ jsxs("h1", { className: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-black mb-8 leading-[1.15] tracking-tight text-dark", children: [
              "Sanmati Spectrum of",
              " ",
              /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary", children: "Knowledge" }),
              /* @__PURE__ */ jsx("br", {}),
              /* @__PURE__ */ jsx("span", { className: "text-dark", children: "& Emerging Discourse" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-lg md:text-xl text-slate-600 font-medium leading-relaxed mb-10 max-w-lg border-l-4 border-primary/40 pl-6", children: "A place for experts to share new ideas. A national, peer-reviewed quarterly journal inviting original research, case studies, and book publications across a wide range of research fields." }),
      ...
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "relative rounded-2xl overflow-hidden shadow-[0_30px_80px_rgba(104,126,255,0.18)] border-2 border-white", children: [
              /* @__PURE__ */ jsx(
                "img",
                {
              ...
              /* @__PURE__ */ jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-8 bg-gradient-to-t from-white/40 via-transparent to-transparent", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-dark/80 text-xs font-bold uppercase tracking-widest", children: "New Submissions Open — 2026" })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex -space-x-3", children: [
                  ["https://i.pravatar.cc/36?img=3", "https://i.pravatar.cc/36?img=5", "https://i.pravatar.cc/36?img=7"].map((src, j) => /* @__PURE__ */ jsx("img", { src, alt: "Reviewer", className: "w-9 h-9 rounded-full border-2 border-white object-cover shadow" }, j)),
                  /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-full border-2 border-white bg-primary flex items-center justify-center text-[10px] font-black text-white shadow", children: "+12" })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 w-full bg-white/80 backdrop-blur-md border-t border-gray-100 py-4 shadow-sm z-20", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-12", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6", children: [
      ...
      /* @__PURE__ */ jsx(item.icon, { className: `w-5 h-5 flex-shrink-0 ${item.color}` }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("p", { className: "text-slate-500 text-[10px] font-black uppercase tracking-widest leading-none mb-0.5", children: item.label }),
        /* @__PURE__ */ jsx("p", { className: "text-slate-800 text-[12px] font-bold", children: item.value })
      ] })
    ] }, i)) }) }) })
  ] });
};
