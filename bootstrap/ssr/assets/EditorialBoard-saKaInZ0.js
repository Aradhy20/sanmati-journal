...
const BoardMember = ({ name, title, affiliation, email, phone, profileUrl, image, role, index }) => {
  ...
  return /* @__PURE__ */ jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 p-6 opacity-5 pointer-events-none transition-opacity duration-500 group-hover:opacity-10", children: /* @__PURE__ */ jsx(Award, { className: "w-24 h-24 text-primary dark:text-primary-light rotate-12" }) }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-5 mb-6 relative z-10", children: [
          /* @__PURE__ */ jsx("div", { className: "w-20 h-20 sm:w-24 sm:h-24 shrink-0 rounded-[1.5rem] overflow-hidden shadow-md border-2 border-white dark:border-slate-800 ring-1 ring-gray-50 dark:ring-slate-700/50 relative bg-surface dark:bg-slate-800 flex items-center justify-center", children: image && !imgError ? /* @__PURE__ */ jsx(
            "img",
            {
              src: image,
              alt: name,
          ...
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("span", { className: "inline-block px-3 py-1 bg-gradient-to-r from-primary/10 to-secondary/10 dark:from-primary/20 dark:to-secondary/20 text-primary dark:text-primary-light text-[9px] font-black uppercase tracking-widest rounded-full mb-2 border border-primary/10", children: title }),
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-serif font-bold text-dark dark:text-white leading-tight group-hover:text-primary dark:group-hover:text-primary-light transition-colors", children: name })
          ] })
        ] }),
        affiliation && /* @__PURE__ */ jsx("p", { className: "text-muted dark:text-slate-400 text-xs sm:text-sm leading-relaxed mb-6 flex-1 relative z-10 font-medium", children: affiliation }),
        (email || phone || profileUrl) && /* @__PURE__ */ jsxs("div", { className: "mt-auto pt-5 border-t border-gray-50 dark:border-slate-800/60 flex flex-col gap-3 relative z-10", children: [
          email && /* @__PURE__ */ jsxs("a", { href: `mailto:${email}`, className: "text-[11px] sm:text-xs font-medium text-dark/70 dark:text-slate-300 hover:text-primary dark:hover:text-primary-light transition-colors flex items-center gap-2 truncate", children: [
            /* @__PURE__ */ jsx(Mail, { className: "w-4 h-4 text-primary/50 shrink-0" }),
            " ",
            /* @__PURE__ */ jsx("span", { className: "truncate", children: email })
          ] }),
          phone && /* @__PURE__ */ jsxs("span", { className: "text-[11px] sm:text-xs font-medium text-dark/70 dark:text-slate-300 flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Phone, { className: "w-4 h-4 text-primary/50 shrink-0" }),
            " ",
            phone
          ] }),
          profileUrl && /* @__PURE__ */ jsxs("a", { href: profileUrl, target: "_blank", rel: "noreferrer", className: "mt-3 inline-flex items-center justify-center w-full py-2.5 bg-surface dark:bg-slate-800 hover:bg-primary/5 text-primary dark:text-primary-light text-[10px] sm:text-[11px] font-black tracking-widest uppercase rounded-xl transition-colors border border-gray-100 dark:border-slate-700 hover:border-primary/20 group/btn gap-2 shadow-sm", children: [
      ...
      "employee": [
        {
          ...
          "jobTitle": "Chief Board Member",
          "affiliation": "Kumar Bhaskar Varma Sanskrit and Ancient Studies University Nalbari, Assam"
        },
        {
          "@type": "Person",
          "name": "Dr. Kalpna Jain",
        ...
        },
        {
          ...
          "jobTitle": "Board Member",
          "affiliation": "Sophia College for Women, Mumbai"
        }
      ]
    }
  };
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-24 relative", children: [
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center mb-16 lg:mb-32", children: [
        /* @__PURE__ */ jsxs(motion.div, { ...fadeInUp, className: "lg:col-span-12 xl:col-span-7", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 mb-8", children: [
            ...
            /* @__PURE__ */ jsx("span", { className: "text-secondary dark:text-cyan-400 font-black text-[11px] uppercase tracking-[0.4em]", children: "Governance" })
          ] }),
          /* @__PURE__ */ jsxs("h2", { className: "text-2xl md:text-3xl lg:text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-dark dark:text-white mb-8 leading-[1.05]", children: [
            "The Vanguard of ",
            /* @__PURE__ */ jsx("br", {}),
            /* @__PURE__ */ jsx("span", { className: "text-primary dark:text-primary-light italic", children: "Academic Rigor" })
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-xl text-dark/70 dark:text-slate-300 font-medium leading-relaxed mb-10 border-l-4 border-primary/20 pl-8", children: "Our editorial governance model is built on transparency, diversity, and an unwavering commitment to empirical excellence." }),
          ...
          ].map((feat, i) => /* @__PURE__ */ jsxs("div", { className: "flex gap-4 p-6 bg-surface dark:bg-slate-900 rounded-3xl border border-gray-50 dark:border-slate-800 hover:shadow-xl transition-all duration-500", children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(Sparkles, { className: "w-5 h-5 text-primary dark:text-primary-light" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("h4", { className: "font-bold text-dark dark:text-white text-sm mb-1", children: feat.title }),
              /* @__PURE__ */ jsx("p", { className: "text-muted dark:text-slate-400 text-xs leading-relaxed", children: feat.text })
            ] })
          ] }, i)) })
        ] }),
        /* @__PURE__ */ jsxs(motion.div, { ...fadeInUp, transition: { delay: 0.2 }, className: "lg:col-span-12 xl:col-span-5 relative group", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "relative aspect-square rounded-[3rem] overflow-hidden shadow-2xl bg-dark", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "absolute inset-x-0 bottom-0 p-6 lg:p-12 text-center", children: [
              /* @__PURE__ */ jsx(Quote, { className: "w-12 h-12 text-secondary dark:text-cyan-400 mx-auto mb-6 opacity-50" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center text-center mb-10 lg:mb-20", children: [
          /* @__PURE__ */ jsx("span", { className: "text-secondary dark:text-cyan-400 font-black text-[10px] uppercase tracking-[0.4em] mb-4", children: "Registry" }),
          /* @__PURE__ */ jsx("h2", { className: "text-2xl md:text-3xl lg:text-4xl font-serif font-bold text-dark dark:text-white mb-4", children: "Esteemed Board" }),
          /* @__PURE__ */ jsx("div", { className: "h-1 w-12 bg-primary dark:bg-primary-light rounded-full" })
        ] }),
