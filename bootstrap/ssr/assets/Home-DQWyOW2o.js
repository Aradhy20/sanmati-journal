...
import { M as MainLayout } from "./MainLayout-CRfW8MNs.js";
    ...
    /* @__PURE__ */ jsxs("div", { className: "container-custom relative z-10", children: [
        ...
        pipelineSteps.map((item, i) => {
          ...
          return /* @__PURE__ */ jsxs(
            motion.button,
            {
              ...
              className: `relative group p-8 flex flex-col items-center text-center rounded-[2rem] transition-all duration-500 cursor-pointer focus:outline-none ${isActive ? "bg-primary shadow-2xl shadow-primary/20 -translate-y-2" : "bg-white border border-gray-100 hover:border-primary/20 hover:shadow-xl hover:-translate-y-1"}`,
              children: [
      ...
      /* @__PURE__ */ jsx(
        motion.div,
        {
          ...
          children: activeStep !== null && /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[2.5rem] border border-primary/10 shadow-2xl p-10 md:p-14 flex flex-col md:flex-row items-start gap-10", children: [
