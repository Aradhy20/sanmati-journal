...
function ResetPassword({ token, email }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-warm-bg flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-300", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "sm:mx-auto sm:w-full sm:max-w-md relative z-10", children: [
      ...
      /* @__PURE__ */ jsx("h2", { className: "text-center text-xl md:text-2xl lg:text-3xl font-serif font-bold text-dark", children: "Set New Password" })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10", children: /* @__PURE__ */ jsx("div", { className: "bg-white py-8 px-4 shadow-xl sm:rounded-2xl sm:px-10 border border-slate-100", children: /* @__PURE__ */ jsxs("form", { className: "space-y-6", onSubmit: submit, children: [
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { htmlFor: "password", className: "block text-sm font-medium text-dark/80", children: "New Password" }),
        /* @__PURE__ */ jsxs("div", { className: "mt-1", children: [
          /* @__PURE__ */ jsx(
            "input",
            {
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { htmlFor: "password_confirmation", className: "block text-sm font-medium text-dark/80", children: "Confirm Password" }),
        /* @__PURE__ */ jsxs("div", { className: "mt-1", children: [
          /* @__PURE__ */ jsx(
            "input",
            {
