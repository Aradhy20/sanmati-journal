...
import { Mail, Phone, MapPin, ChevronDown, ArrowUpRight, Sun, Moon, X, Menu, Send, Linkedin, Facebook, Twitter, UploadCloud, MessageCircle, FileText } from "lucide-react";
          ...
          "div",
          {
            ...
            children: [
              item.href === "#" ? /* @__PURE__ */ jsx(
                "button",
                {
                  className: `relative flex flex-col items-center text-[13px] font-bold px-5 py-2 rounded-full transition-all whitespace-nowrap tracking-wide ${isActive(item.href) ? "text-primary bg-primary/5" : "text-dark/80 hover:text-primary hover:bg-primary/5"}`,
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 sm:gap-3", children: [
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: dark ? /* @__PURE__ */ jsx(Sun, { className: "w-4 h-4 text-amber-500" }) : /* @__PURE__ */ jsx(Moon, { className: "w-4 h-4 text-slate-600" })
            }
          ),
          /* @__PURE__ */ jsx(
            "button",
