...
const Hero = () => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "relative flex flex-col min-h-[100svh] overflow-hidden bg-[#050B14] justify-center pt-24", children: [
    /* @__PURE__ */ jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxs("div", { className: "absolute inset-0 z-0 pointer-events-none", children: [
      /* @__PURE__ */ jsx("div", { className: "absolute top-[10%] left-[5%] w-[400px] h-[400px] bg-blue-600/20 rounded-full blur-[120px] animate-pulse", style: { animationDuration: "8s" } }),
      /* @__PURE__ */ jsx("div", { className: "absolute bottom-[10%] right-[10%] w-[500px] h-[500px] bg-purple-600/15 rounded-full blur-[140px] animate-pulse", style: { animationDuration: "12s" } })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "absolute inset-0 z-0 bg-gradient-to-b from-[#050B14]/90 via-[#0a1222]/95 to-[#050B14]" }),
    /* @__PURE__ */ jsx("div", { className: "relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 lg:py-24 flex-grow flex flex-col justify-center", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center", children: [
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs(motion.div, { variants: itemVariants, className: "inline-flex items-center gap-2.5 px-4 py-2 bg-white/5 backdrop-blur-md border border-white/10 rounded-full shadow-lg", children: [
              /* @__PURE__ */ jsx(Sparkles, { className: "w-4 h-4 text-cyan-400 animate-pulse" }),
              /* @__PURE__ */ jsx("span", { className: "text-white font-black text-[10px] sm:text-[11px] uppercase tracking-[0.3em]", children: "ISSN: 3108-1819 · Peer-Reviewed Multidisciplinary Journal" })
            ] }),
            /* @__PURE__ */ jsx(motion.p, { variants: itemVariants, className: "text-cyan-400 text-base sm:text-lg font-bold font-sans tracking-wide", lang: "hi", children: "ज्ञान, शोध और प्रकाशन का एक राष्ट्रीय एवं अन्तर्राष्ट्रीय मंच" }),
            /* @__PURE__ */ jsxs(motion.h1, { variants: itemVariants, className: "text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-black leading-[1.1] tracking-tight text-white", children: [
              "Bridging Scholarly Rigor with ",
              /* @__PURE__ */ jsx("span", { className: "text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400", children: "Global Discovery" })
            ] }),
            /* @__PURE__ */ jsx(motion.p, { variants: itemVariants, className: "text-base sm:text-lg md:text-xl text-slate-300 leading-relaxed max-w-xl border-l-4 border-cyan-500 pl-6 font-medium", children: "Welcome to Sanmati Spectrum of Knowledge, India's premier national multidisciplinary research platform. We empower authors with high-impact publishing, blind peer review, and global open-access indexing." }),
      ...
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "relative rounded-[2.5rem] overflow-hidden shadow-2xl bg-white/5 backdrop-blur-md p-3 border border-white/10 group", children: [
              /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-gradient-to-tr from-blue-600/10 via-transparent to-purple-600/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" }),
              /* @__PURE__ */ jsx(
                "img",
                {
              ...
              /* @__PURE__ */ jsxs("div", { className: "absolute bottom-6 left-6 right-6 p-6 bg-[#0c1322]/90 backdrop-blur-xl rounded-2xl border border-white/10 shadow-xl", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2.5 mb-2.5", children: [
                  ...
                  /* @__PURE__ */ jsx("span", { className: "text-cyan-400 text-[10px] font-black uppercase tracking-[0.2em]", children: "Call For Papers Active" })
                ] }),
            ...
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("div", { className: "w-11 h-11 rounded-xl bg-gradient-to-br from-blue-600/20 to-purple-600/20 flex items-center justify-center border border-white/5", children: /* @__PURE__ */ jsx(Users, { className: "w-5 h-5 text-cyan-400" }) }),
            ...
            /* @__PURE__ */ jsxs(
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { children: [
                    /* @__PURE__ */ jsx("p", { className: "text-base font-black text-white leading-none", children: "Double-Blind" }),
