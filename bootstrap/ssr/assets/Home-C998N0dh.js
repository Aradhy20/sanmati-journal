  ...
  return /* @__PURE__ */ jsxs(
    MainLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("section", { className: "py-16 lg:py-24 bg-surface relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsx("section", { className: "py-16 lg:py-24 bg-warm-bg", children: /* @__PURE__ */ jsxs("div", { className: "container-custom", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-6 lg:gap-8 items-stretch", children: [
            {
            ...
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "p-6 lg:p-8 flex flex-col justify-between flex-grow", children: [
        ...
        /* @__PURE__ */ jsx("section", { className: "py-16 lg:py-24 bg-white relative", children: /* @__PURE__ */ jsxs("div", { className: "container-custom", children: [
            ...
            /* @__PURE__ */ jsx(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, className: "group", children: /* @__PURE__ */ jsxs("div", { className: "h-full rounded-2xl overflow-hidden bg-gradient-to-br from-primary to-primary-dark text-white p-10 flex flex-col items-center text-center shadow-2xl hover:-translate-y-1 transition-all duration-700 relative", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "w-full bg-white/10 rounded-2xl p-4 mb-6 border border-white/10 text-xs", children: [
                ...
                /* @__PURE__ */ jsxs("p", { className: "flex justify-between", children: [
                  ...
                  " ",
                  /* @__PURE__ */ jsx("span", { className: "font-bold", children: "+91 9870713912" })
                ] })
              ] }),
        ...
        /* @__PURE__ */ jsxs("section", { className: "py-10 lg:py-16 relative overflow-hidden bg-[#050B14]", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              className: "absolute inset-0 z-0 opacity-60 mix-blend-screen",
          ...
          /* @__PURE__ */ jsx("div", { className: "absolute inset-0 z-0 bg-gradient-to-br from-[#10245E]/80 to-[#1e1b4b]/80 mix-blend-multiply" }),
          ...
          /* @__PURE__ */ jsx("div", { className: "container-custom relative z-10", children: /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-12 text-center", children: [
            ...
            motion.div,
            {
              ...
              className: "group",
              children: [
                /* @__PURE__ */ jsx("div", { className: "w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 md:mb-6 rounded-2xl bg-white/10 border border-white/20 flex items-center justify-center group-hover:bg-white/20 transition-all duration-500", children: /* @__PURE__ */ jsx(stat.icon, { className: "w-6 h-6 md:w-8 md:h-8 text-white/80 group-hover:scale-110 transition-transform" }) }),
                /* @__PURE__ */ jsxs("div", { className: "text-2xl md:text-3xl lg:text-4xl font-black text-white mb-2 tracking-tighter", children: [
                  /* @__PURE__ */ jsx(AnimatedCounter, { from: 0, to: stat.num, duration: 2 }),
                  stat.suffix
                ] }),
        ...
        /* @__PURE__ */ jsx("section", { className: "py-16 lg:py-24 bg-white relative overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "container-custom", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-20 items-center", children: [
          /* @__PURE__ */ jsxs(
            motion.div,
            {
        ...
        /* @__PURE__ */ jsx("section", { className: "pb-12 lg:pb-20 pt-4 bg-warm-bg border-b border-gray-100", children: /* @__PURE__ */ jsxs("div", { className: "container-custom", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-center items-center gap-4 md:gap-12 opacity-70", children: [
            /* @__PURE__ */ jsx("div", { className: "font-bold text-sm md:text-lg tracking-tight text-gray-500", children: "Google Scholar" }),
            /* @__PURE__ */ jsx("div", { className: "font-bold text-sm md:text-lg tracking-tight text-gray-500", children: "CrossRef" }),
            /* @__PURE__ */ jsx("div", { className: "font-bold text-sm md:text-lg tracking-tight text-gray-500", children: "UGC CARE (Proposed)" }),
            /* @__PURE__ */ jsx("div", { className: "font-bold text-sm md:text-lg tracking-tight text-gray-500", children: "Directory of Open Access Journals (DOAJ)" }),
            /* @__PURE__ */ jsx("div", { className: "font-bold text-sm md:text-lg tracking-tight text-gray-500", children: "ResearchGate" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxs("section", { className: "py-16 lg:py-24 bg-white relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "container-custom relative z-10", children: [
            /* @__PURE__ */ jsxs(motion.div, { ...fadeInUp, className: "flex flex-col md:flex-row items-end justify-between gap-8 mb-14", children: [
              ...
              /* @__PURE__ */ jsxs(Link, { href: "/archive", className: "flex items-center gap-2 text-xs font-black uppercase tracking-widest text-dark/60 hover:text-primary transition-colors group shrink-0", children: [
                "Browse All Journal Insights ",
                /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 group-hover:translate-x-1.5 transition-transform" })
              ] })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [
              { rank: "01", field: "Multidisciplinary", title: "Sanmati Spectrum of Knowledge & Emerging Discourse (January-March, 2026)", authors: "Dr Namrata Jain, Dr. Ratnesh Kumar Jain", doi: "https://doi.org/10.5281/zenodo.19710093", reads: "Featured Issue", tag: "Hot" },
              ...
              motion.div,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx("p", { className: "text-muted text-[12px] font-medium mb-4 truncate", children: paper.authors }),
                  paper.doi && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-primary font-bold text-[9px] uppercase tracking-widest mb-6", children: [
                    /* @__PURE__ */ jsx("span", { className: "opacity-40 text-dark", children: "DOI:" }),
                    /* @__PURE__ */ jsx("a", { href: paper.doi, target: "_blank", rel: "noopener noreferrer", className: "hover:underline", children: paper.doi.replace("https://doi.org/", "") })
                  ] }),
