...
const Hero = React.lazy(() => import("./Hero-4-bVSJYx.js"));
const fadeInUp = {
      ...
      return /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: `font-serif font-bold text-4xl block mb-4 ${isActive ? "text-white/10" : "text-slate-100 group-hover:text-slate-200"} transition-colors`, children: item.step }),
