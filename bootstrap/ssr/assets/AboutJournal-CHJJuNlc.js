          ...
          /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-8 bg-gradient-to-br from-primary/5 to-transparent rounded-3xl border border-primary/10 mt-6", children: [
                ...
                /* @__PURE__ */ jsx("h4", { className: "text-xl font-bold text-dark mb-2", children: "Sanmati Publication" }),
                /* @__PURE__ */ jsx("p", { className: "text-muted text-sm leading-relaxed", children: "Moradabad – 244001, Bharat (India)" })
              ] })
            ] })
          ] })
        ] })
