...
import { M as MainLayout } from "./MainLayout-DYvdgHCs.js";
...
const Hero = React.lazy(() => import("./Hero-ITreP8AR.js"));
const fadeInUp = {
  initial: { opacity: 0, y: 20 },
  whileInView: { opacity: 1, y: 0 },
                  ...
                  motion.div,
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center", children: [
                        /* @__PURE__ */ jsx("div", { className: `w-20 h-20 rounded-[1.75rem] ${cat.color} flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-primary group-hover:text-white transition-all duration-500 shadow-sm shrink-0`, children: /* @__PURE__ */ jsx(cat.icon, { className: "w-9 h-9" }) }),
