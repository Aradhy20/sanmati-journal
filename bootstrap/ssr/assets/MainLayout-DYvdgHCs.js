...
import { ChevronDown, ArrowUpRight, Sun, Moon, X, Menu, Mail, Send, Linkedin, Facebook, MapPin, Phone, MessageCircle } from "lucide-react";
...
const Navbar = () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "bg-primary-dark text-white border-b border-primary/50 sticky top-0 z-50", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 py-2 flex flex-col md:flex-row items-center justify-between gap-2 md:gap-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4 text-[11px] font-bold tracking-widest uppercase text-white/80", children: [
        /* @__PURE__ */ jsx("span", { children: "ISSN: 3108-1819" }),
        /* @__PURE__ */ jsx("span", { className: "w-1 h-1 rounded-full bg-secondary" }),
        /* @__PURE__ */ jsx("span", { children: "UGC CARE Listed (Proposed)" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("span", { className: "text-[11px] font-black uppercase tracking-widest text-secondary", children: "Next Current Cycle Closes In" }),
        /* @__PURE__ */ jsx(CountdownTimer, { targetDate, className: "scale-75 origin-left" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("nav", { className: `sticky top-[52px] w-full z-40 transition-all duration-500 ease-[0.22,1,0.36,1] ${scrolled ? "bg-white shadow-md border-b border-gray-200 py-2" : "bg-white border-b border-gray-100 py-4"}`, children: [
      /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-6 lg:px-12", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between h-16", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "hidden xl:flex items-center gap-8", children: navItems.map((item) => /* @__PURE__ */ jsxs(
          "div",
          {
            className: "relative",
  ...
  return /* @__PURE__ */ jsxs("footer", { className: "relative overflow-hidden bg-dark text-white/70", children: [
    /* @__PURE__ */ jsxs("div", { className: "bg-primary/5 border-b border-white/5 relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-6 lg:px-8 py-12 relative z-10", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row items-center justify-between gap-8", children: [
        ...
        /* @__PURE__ */ jsxs("form", { action: "https://formspree.io/f/PLACEHOLDER_ENDPOINT", method: "POST", className: "flex w-full lg:w-auto gap-3", children: [
