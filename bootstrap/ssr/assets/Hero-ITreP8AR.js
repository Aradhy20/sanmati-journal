...
const Hero = () => {
  return /* @__PURE__ */ jsxs("section", { className: "relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-[#eef1ff] via-[#f5f0ff] to-[#fff0f5]", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 pt-32 pb-24 lg:pt-36 lg:pb-28", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-start", children: [
        ...
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs("h1", { className: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-black mb-8 leading-[1.15] tracking-tight text-[#052143]", children: [
              ...
              /* @__PURE__ */ jsx("br", {}),
              /* @__PURE__ */ jsx("span", { className: "text-[#052143]", children: "& New Ideas & Research" })
            ] }),
            /* @__PURE__ */ jsx("p", { className: "text-lg md:text-xl text-slate-600 font-medium leading-relaxed mb-10 max-w-lg border-l-4 border-[#687EFF]/40 pl-6", children: "A place for experts to share new ideas. A national, peer-reviewed quarterly journal inviting original research, case studies, and book publications across a wide range of research fields." }),
      ...
      /* @__PURE__ */ jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "relative rounded-[3rem] overflow-hidden shadow-[0_30px_80px_rgba(104,126,255,0.18)] border-2 border-white", children: [
              /* @__PURE__ */ jsx(
                "img",
                {
    ...
    /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 w-full bg-white/80 backdrop-blur-md border-t border-gray-100 py-4 shadow-sm z-20", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-12", children: /* @__PURE__ */ jsx("div", { className: "flex flex-wrap items-center justify-center sm:justify-between gap-6 md:gap-8", children: [
