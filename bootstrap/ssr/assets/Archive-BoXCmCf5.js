...
import { Archive as Archive$1, Search, Calendar, Layers, FileText, Download } from "lucide-react";
...
function Archive({ issues = [] }) {
  ...
  return /* @__PURE__ */ jsxs(MainLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-24 relative", children: [
      ...
      issueList.length > 0 ? /* @__PURE__ */ jsx("div", { className: "space-y-20", children: issueList.map((issue, idx) => {
        var _a;
                  ...
                  motion.div,
                  {
                    ...
                    children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col md:flex-row md:items-center justify-between gap-6", children: [
                      /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
                        ...
                        /* @__PURE__ */ jsx("h4", { className: "text-xl font-bold text-dark mb-3 group-hover:text-primary transition-colors", children: paper.title }),
