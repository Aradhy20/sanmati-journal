...
import { FileText, UploadCloud, ShieldCheck, CheckCircle, ArrowRight } from "lucide-react";
...
function CallForPapers() {
  ...
  return /* @__PURE__ */ jsx(MainLayout, { children: /* @__PURE__ */ jsxs("div", { className: "bg-[#eef1ff] min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-24 relative", children: [
      step < 4 && /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-12 relative", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute top-1/2 left-0 w-full h-1 bg-gray-200 -z-10 -translate-y-1/2 rounded-full" }),
        /* @__PURE__ */ jsx("div", { className: `absolute top-1/2 left-0 h-1 bg-blue-600 -z-10 -translate-y-1/2 rounded-full transition-all duration-500`, style: { width: `${(step - 1) * 50}%` } }),
        [
        ...
        step < 4 && /* @__PURE__ */ jsx("form", { onSubmit: step === 3 ? submit : handleNextStep, encType: "multipart/form-data", children: /* @__PURE__ */ jsxs(AnimatePresence, { mode: "wait", children: [
          step === 1 && /* @__PURE__ */ jsxs(motion.div, { initial: { opacity: 0, x: 20 }, animate: { opacity: 1, x: 0 }, exit: { opacity: 0, x: -20 }, children: [
            /* @__PURE__ */ jsxs("div", { className: "mb-10", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-slate-500", children: "Provide the foundational metadata for indexing and peer-review matching." })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              ...
              /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-slate-700 mb-2", children: "Abstract Synopsis *" }),
                /* @__PURE__ */ jsx(
                  "textarea",
                  {
                    value: data.abstract,
          ...
          step === 2 && /* @__PURE__ */ jsxs(motion.div, { initial: { opacity: 0, x: 20 }, animate: { opacity: 1, x: 0 }, exit: { opacity: 0, x: -20 }, children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "relative border-2 border-dashed border-gray-300 rounded-3xl p-6 lg:p-12 text-center hover:bg-slate-50 hover:border-blue-400 transition-colors group cursor-pointer", children: [
              /* @__PURE__ */ jsx(
                "input",
                {
                  type: "file",
              ...
              /* @__PURE__ */ jsx("div", { className: "w-20 h-20 bg-blue-50 text-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-500 shadow-inner", children: /* @__PURE__ */ jsx(UploadCloud, { className: "w-10 h-10" }) }),
              data.manuscript ? /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-lg font-bold text-slate-900 mb-2", children: data.manuscript.name }),
                /* @__PURE__ */ jsxs("p", { className: "text-sm font-medium text-green-600 bg-green-50 inline-block px-4 py-1 rounded-full border border-green-200", children: [
                  /* @__PURE__ */ jsx(CheckCircle, { className: "w-4 h-4 inline mr-1" }),
                  " File Attached"
                ] })
              ] }) : /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx("p", { className: "text-xl font-bold text-slate-700 mb-2 group-hover:text-blue-600 transition-colors", children: "Drag & Drop or Click to Browse" }),
                /* @__PURE__ */ jsx("p", { className: "text-slate-400 font-medium", children: "Strictly .pdf files under 10MB" })
              ] }),
              errors.manuscript && /* @__PURE__ */ jsx("p", { className: "text-red-500 text-sm mt-4 font-bold", children: errors.manuscript })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "mt-10 flex justify-between", children: [
              /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setStep(1), className: "px-8 py-4 bg-white text-slate-700 border border-gray-200 font-bold rounded-xl hover:bg-slate-50 transition-colors", children: "Back" }),
              /* @__PURE__ */ jsxs("button", { type: "submit", disabled: !data.manuscript, className: "px-8 py-4 bg-slate-900 text-white font-bold rounded-xl hover:bg-blue-600 transition-colors flex items-center gap-2 group disabled:opacity-50", children: [
                "Final Step ",
                /* @__PURE__ */ jsx(ArrowRight, { className: "w-5 h-5 group-hover:translate-x-1 transition-transform" })
              ] })
            ] })
