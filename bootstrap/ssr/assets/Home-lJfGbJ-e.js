      ...
      return /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("span", { className: `font-serif font-bold text-4xl block mb-4 ${isActive ? "text-white/30" : "text-slate-300 group-hover:text-slate-400"} transition-colors`, children: item.step }),
