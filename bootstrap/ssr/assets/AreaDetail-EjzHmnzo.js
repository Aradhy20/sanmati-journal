...
import { M as MainLayout, S as Seo } from "./MainLayout-BOqdCzM5.js";
import { S as ScrollReveal, r as revealVariants } from "./ScrollReveal-1c_Su25q.js";
import { G as GridPattern } from "./Graphics-CZ-Bhg_h.js";
import { Microscope, Newspaper, Leaf, BookOpen, HeartPulse, Scale, Briefcase, Globe, Cpu, Palette, ArrowRight, FileText, CheckCircle2, Share2 } from "lucide-react";
...
const areasData = {
  ...
  "indian-knowledge-systems": {
    ...
    icon: Microscope,
    // Using Microscope as a placeholder for deep study
    color: "orange",
    ...
    topics: [
      ...
      "Yoga & Consciousness Studies",
      "Vedic Mathematics & Astronomy",
      "Indian Philosophy (Darshanas)",
      "Ancient Indian Architecture (Vastu)",
      "Sanskrit Heritage",
      "Arthashastra & Governance",
...
function AreaDetail({ slug }) {
  ...
  if (!area) {
    return /* @__PURE__ */ jsxs(MainLayout, { children: [
      /* @__PURE__ */ jsx(PageHeader, { title: "Area Not Found", breadcrumb: "Submission Guidelines" }),
      /* @__PURE__ */ jsxs("div", { className: "text-center py-20", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-dark", children: "Topic not found" }),
        /* @__PURE__ */ jsx(Link, { href: "/submission-guidelines/areas", className: "text-primary hover:underline mt-4 block", children: "Back to Areas" })
      ] })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxs(MainLayout, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative h-[60vh] min-h-[500px] flex items-end pb-20 overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "absolute inset-0", children: [
        /* @__PURE__ */ jsx("img", { loading: "lazy", src: area.heroImage, alt: area.title, className: "w-full h-full object-cover" }),
        /* @__PURE__ */ jsx("div", { className: `absolute inset-0 bg-gradient-to-t from-${area.color}-900/95 via-${area.color}-900/70 to-black/30` }),
        /* @__PURE__ */ jsx(GridPattern, { className: "absolute top-0 right-0 text-white/10 w-full h-full opacity-30" })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full", children: /* @__PURE__ */ jsxs(ScrollReveal, { children: [
        /* @__PURE__ */ jsxs(Link, { href: "/submission-guidelines/areas", className: "inline-flex items-center text-white/80 hover:text-white mb-6 text-sm font-medium transition-colors", children: [
          /* @__PURE__ */ jsx(ArrowRight, { className: "w-4 h-4 mr-2 rotate-180" }),
          " Back to All Areas"
        ] }),
        /* @__PURE__ */ jsxs("div", { className: `inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-white/10 text-white backdrop-blur-md border border-white/20 text-sm font-bold uppercase tracking-wider mb-6`, children: [
          /* @__PURE__ */ jsx(Icon, { className: "w-4 h-4" }),
          " ",
          area.title
        ] }),
        /* @__PURE__ */ jsx("h1", { className: "text-2xl md:text-3xl lg:text-4xl md:text-6xl font-bold text-white mb-6 leading-tight max-w-3xl", children: area.desc })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "bg-warm-bg py-20", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-12", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-12", children: [
        /* @__PURE__ */ jsx(ScrollReveal, { variants: revealVariants.fadeUp, children: /* @__PURE__ */ jsxs("div", { className: "bg-white p-8 md:p-10 rounded-[2rem] shadow-sm border border-slate-100", children: [
          /* @__PURE__ */ jsxs("h2", { className: "text-2xl font-bold text-dark mb-6 flex items-center gap-3", children: [
            /* @__PURE__ */ jsx(Microscope, { className: `text-${area.color}-600` }),
            " Scope of Research"
          ] }),
          /* @__PURE__ */ jsx("p", { className: "text-lg text-gray-600 leading-loose", children: area.scope })
        ] }) }),
        /* @__PURE__ */ jsxs(ScrollReveal, { variants: revealVariants.fadeUp, delay: 0.2, children: [
          /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold text-dark mb-8 mt-4", children: "Key Research Topics" }),
          /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: area.topics.map((topic, i) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-4 p-4 rounded-xl bg-white border border-slate-100 hover:border-primary/20 transition-colors shadow-sm group", children: [
            /* @__PURE__ */ jsx("div", { className: `mt-1 p-2 rounded-lg bg-${area.color}-50 text-${area.color}-600 group-hover:bg-${area.color}-600 group-hover:text-white transition-colors`, children: /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-current" }) }),
            /* @__PURE__ */ jsx("span", { className: "text-dark/80 font-medium group-hover:text-dark transition-colors", children: topic })
          ] }, i)) })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "lg:col-span-1", children: /* @__PURE__ */ jsxs("div", { className: "sticky top-24 space-y-6", children: [
        /* @__PURE__ */ jsx(ScrollReveal, { variants: revealVariants.left, delay: 0.3, children: /* @__PURE__ */ jsxs("div", { className: "bg-white p-8 rounded-3xl shadow-xl border border-slate-100 overflow-hidden relative group", children: [
          /* @__PURE__ */ jsx("div", { className: `absolute inset-0 bg-gradient-to-br from-${area.color}-600 to-${area.color}-800 opacity-90 transition-opacity group-hover:opacity-100` }),
          /* @__PURE__ */ jsxs("div", { className: "relative z-10 text-white", children: [
            /* @__PURE__ */ jsx(FileText, { className: "w-10 h-10 mb-4 opacity-80" }),
            /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold mb-2", children: "Ready to Submit?" }),
            /* @__PURE__ */ jsx("p", { className: "text-white/80 text-sm mb-6 leading-relaxed", children: "Ensure your manuscript aligns with the topics listed. We review submissions on a rolling basis." }),
            /* @__PURE__ */ jsx(Link, { href: "/contact", className: "block w-full py-3.5 bg-white text-dark rounded-xl font-bold text-center hover:bg-warm-bg transition-colors", children: "Submit Paper Now" })
          ] })
        ] }) }),
        /* @__PURE__ */ jsx(ScrollReveal, { variants: revealVariants.left, delay: 0.4, children: /* @__PURE__ */ jsxs("div", { className: "bg-white p-6 rounded-3xl border border-gray-200 shadow-sm", children: [
          /* @__PURE__ */ jsxs("h4", { className: "text-dark font-bold mb-4 flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(CheckCircle2, { className: "text-green-500 w-5 h-5" }),
            " Submission Requirements"
          ] }),
          /* @__PURE__ */ jsxs("ul", { className: "space-y-3 text-sm text-gray-600", children: [
            /* @__PURE__ */ jsxs("li", { className: "flex gap-3", children: [
              /* @__PURE__ */ jsx("div", { className: "w-1.5 h-1.5 rounded-full bg-slate-300 mt-2" }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 text-gray-400 text-sm font-medium cursor-pointer hover:text-primary transition-colors", children: [
