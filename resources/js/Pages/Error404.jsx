...
export default function Error404() {
    return (
        <MainLayout>
            ...
            <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#eef1ff] via-[#f5f0ff] to-[#fff0f5] relative overflow-hidden px-6">

                {/* Background blobs */}
                <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-[#687EFF]/10 rounded-full blur-[180px]" />
                    <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-[#F87A53]/8 rounded-full blur-[160px]" />
                </div>
                ...
                <div className="relative z-10 text-center max-w-2xl mx-auto">
                    ...
                    >
                        <div className="relative w-40 h-40 rounded-[3rem] bg-white shadow-2xl border border-[#687EFF]/20 flex items-center justify-center">
                            <BookOpen className="w-20 h-20 text-[#687EFF]/30" />
                            <motion.div
                    ...
                    >
                        ...
                        <p className="text-[#6B778B] text-lg font-medium leading-relaxed mb-12 max-w-lg mx-auto">
                            The scholarly page you are seeking has moved, been retracted, or never existed. Let us guide you back to the knowledge base.
                        </p>
                        ...
                        {/* Quick links */}
                        <div className="mt-16 pt-10 border-t border-[#687EFF]/10">
                            <p className="text-[#6B778B] text-xs font-bold uppercase tracking-widest mb-6">Popular Destinations</p>
