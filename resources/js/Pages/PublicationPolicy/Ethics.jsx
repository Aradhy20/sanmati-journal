...
export default function Ethics() {
    return (
        <MainLayout>
            <div className="bg-warm-bg min-h-screen relative">
                        ...
                        <div className="max-w-4xl mx-auto space-y-12 mt-12">
                            ...
                            <div className="bg-white p-10 rounded-2xl shadow-xl border border-slate-100 relative overflow-hidden">
                                ...
                                <div className="flex items-center gap-4 mb-6">
                                    <div className="p-3 bg-primary/5 rounded-xl text-primary-dark ring-1 ring-blue-100">
                                        <ShieldCheck className="w-8 h-8" />
                                    </div>
                                    <h2 className="text-2xl font-serif font-bold text-dark">Ethical Standards</h2>
                                </div>
                                ...
                                <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {['Fairness', 'Transparency', 'Objectivity', 'Accountability'].map((item, i) => (
                                        <li key={i} className="flex items-center gap-3 p-4 bg-warm-bg rounded-xl border border-slate-100 hover:border-primary/20 transition-colors">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <ScrollReveal delay={0.1} variants={revealVariants.left} className="h-full">
                                    <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-lg h-full hover:shadow-xl transition-shadow">
                                        <div className="mb-6 text-primary bg-primary/5 w-fit p-3 rounded-xl"><Scale className="w-8 h-8" /></div>
                                        <h3 className="text-xl font-bold text-dark mb-3">Misconduct Policy</h3>
                                ...
                                <ScrollReveal delay={0.2} variants={revealVariants.right} className="h-full">
                                    <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-lg h-full hover:shadow-xl transition-shadow">
                                        ...
                                        <h3 className="text-xl font-bold text-dark mb-3">Author Responsibility</h3>
                                        <p className="text-gray-600 leading-relaxed">
