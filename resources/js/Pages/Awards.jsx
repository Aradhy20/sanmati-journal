                    ...
                    <div className="max-w-5xl mx-auto mt-12">
                        <div className="bg-white p-8 md:p-12 rounded-3xl border border-gray-200 shadow-sm relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <h2 className="text-3xl font-serif font-bold text-dark mb-6 font-serif">Honoring Excellence</h2>
                                <p className="text-dark/80 text-lg leading-relaxed mb-16 max-w-3xl">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
                                    {awards.map((award, i) => (
                                        <div key={i} className="group p-8 bg-warm-bg rounded-[40px] border border-slate-100 hover:bg-white hover:shadow-2xl hover:border-primary/20 transition-all duration-300 flex flex-col items-center text-center">
                                            ...
                                            <div className="text-[10px] font-black uppercase tracking-[0.2em] text-primary mb-2">{award.category}</div>
                                            <h3 className="text-xl font-bold text-dark mb-4">{award.title}</h3>
                                ...
                                <div className="flex flex-col md:flex-row gap-8 items-stretch">
                                    <div className="flex-1 p-10 bg-gradient-to-br from-blue-900 to-indigo-900 text-white rounded-[48px] shadow-2xl shadow-blue-900/20 relative overflow-hidden">
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <div className="flex flex-col gap-4">
                                                <Link href="/contact" className="group inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-dark font-bold rounded-full hover:bg-primary/5 transition-all shadow-lg hover:shadow-xl">
                                    ...
                                    <div className="w-full md:w-80 p-8 border-2 border-slate-100 rounded-[48px] flex flex-col justify-center items-center text-center">
                                        <p className="text-gray-400 text-xs font-bold uppercase tracking-widest mb-4">Inquiry</p>
                                        <p className="text-gray-600 text-sm leading-relaxed mb-6 font-serif px-4">
                                            Questions regarding eligibility criteria or submission process?
                                        </p>
                                        <a href="mailto:sanmatijournal@gmail.com" className="text-primary font-bold flex items-center gap-2">
