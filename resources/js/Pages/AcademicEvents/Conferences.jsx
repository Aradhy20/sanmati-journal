                        ...
                        <ScrollReveal variants={revealVariants.zoom}>
                            <div className="bg-white p-8 md:p-12 rounded-3xl border border-gray-200 shadow-sm relative overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    <h2 className="text-xl md:text-2xl lg:text-3xl font-serif font-bold text-dark mb-6">International Conferences</h2>
                                                    ...
                                                    <div className="p-1 border border-slate-100 rounded-[32px] bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl shadow-blue-500/10">
                                                        <div className="bg-white rounded-[31px] p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-8">
                                                            <div className="flex-grow">
                                                                <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-primary/5 text-primary-dark text-[10px] font-black uppercase tracking-widest rounded-full mb-4">
                                                                    <ShieldCheck className="w-3 h-3" /> Peer Reviewed
                                                                </div>
                                                                <h3 className="text-2xl font-black text-dark mb-3 leading-tight">{conf.title}</h3>
                                                                <div className="flex flex-wrap gap-5 text-sm font-bold text-gray-500">
                                                                    <div className="flex items-center gap-2"><Calendar className="w-4 h-4 text-primary" /> {conf.date}</div>
                                                                    <div className="flex items-center gap-2"><MapPin className="w-4 h-4 text-primary" /> {conf.location}</div>
                                                                </div>
                                                            </div>
                                                            <button className="shrink-0 px-8 py-4 bg-dark text-white font-black uppercase tracking-widest rounded-2xl hover:bg-slate-800 transition-all flex items-center gap-2 text-xs">
                                    ...
                                    <ScrollReveal variants={revealVariants.zoom} delay={0.2}>
                                        <div className="p-8 bg-warm-bg rounded-3xl border border-gray-200 relative overflow-hidden">
                                            <GridPattern className="opacity-5" />
                                            <h4 className="text-lg font-bold text-dark mb-4">Call for Collaboration</h4>
                                            ...
                                            <a href="mailto:sanmatijournal@gmail.com" className="flex items-center gap-2 text-primary font-bold hover:underline">
