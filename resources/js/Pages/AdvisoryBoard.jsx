...
import { Award, GraduationCap, ChevronRight, Sparkles, Quote, LibraryBig } from 'lucide-react';
        ...
        >
            ...
            <div className="relative h-full bg-white border border-gray-100 rounded-[2.5rem] overflow-hidden flex flex-col hover:shadow-2xl hover:-translate-y-2 transition-all duration-500">
                ...
                <div className="relative aspect-[4/5] overflow-hidden bg-dark">
                    <img 
                        src={image || `/fistudy-assets/team/team-2-${(index % 3) + 1}.jpg`} 
                        alt={name}
                    ...
                    <div className="absolute top-6 left-6 flex flex-col gap-2">
                        <span className="px-4 py-1.5 rounded-full text-[9px] font-black uppercase tracking-[0.2em] shadow-xl backdrop-blur-md bg-white/10 text-white/70 border border-white/10">
                            <LibraryBig className="w-3 h-3 inline mr-2 align-middle" />
                            {title}
                        </span>
                    </div>
                    ...
                    <div className="absolute bottom-6 left-6 right-6">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-secondary font-black text-[9px] uppercase tracking-[0.3em]">Advisory Board</span>
                        </div>
                ...
                <div className="p-8 flex-1 flex flex-col bg-white">
                    ...
                    <div className="w-full bg-warm-bg rounded-2xl p-4 mb-6 border border-gray-50 text-xs text-left text-dark">
                        {email && <p className="flex justify-between border-b border-gray-200 pb-2 mb-2"><span className="text-muted uppercase tracking-widest font-black text-[9px]">Email</span> <a href={`mailto:${email}`} className="font-bold text-dark hover:text-primary transition-colors truncate ml-2 text-right">{email}</a></p>}
                        {phone && <p className="flex justify-between"><span className="text-muted uppercase tracking-widest font-black text-[9px]">Mob</span> <span className="font-bold text-dark text-right">{phone}</span></p>}
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                        {[
                            ...
                            },
                            {
                                ...
                                email: "Dean.nursing@tmu.ac.in",
                                phone: "+91 6399000660",
                                profileUrl: "https://www.tmu.ac.in/tmu/university-administration",
                            ...
                            },
                            {
                                ...
                                email: "sushilkumarmpi@gmail.com",
                                phone: "+91 9140091434",
                                profileUrl: "https://doe.bnmu.ac.in/faculty",
                                image: "/images/team/dr_sushil_kumar.jpeg"
                            },
                            {
                                name: "Dr. Rakesh Kumar",
                                title: "Advisory Member",
                                affiliation: "Associate Professor, Faculty of Law & Legal Studies, Teerthanker Mahaveer University Moradabad (Uttar Pradesh)",
                                email: "rakesh.law@tmu.ac.in",
                                phone: "+91 8920240003",
                                profileUrl: "https://share.google/oFLmxCRj8vPGhBcOS"
                            },
                            {
                                name: "Dr. Harishchandra Verma",
                                title: "Advisory Member",
                                affiliation: "Principal/Director, Shri Vishwanath College of Pharmacy, Sultanpur (Uttar Pradesh)",
                                email: "harishpharma2007@gmail.com",
                                phone: "+91 7535074735",
                                profileUrl: "https://www.svnpharmacy.ac.in/director-message"
                            },
                            {
                                name: "Dr. Vipin Kumar",
                                title: "Advisory Member",
