...
export default function ImportantInformation() {
    const guidelines = [
        ...
        { label: "Submission Email", value: "sanmatijournal@gmail.com", icon: <Mail className="w-5 h-5 text-primary" /> },
        ...
        { label: "Submission Format", value: "MS Word (.doc/.docx)", icon: <BookOpen className="w-5 h-5 text-primary" /> },
        ...
        { label: "Maximum Co-authors", value: "Two", icon: <Users className="w-5 h-5 text-secondary" /> },
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2">
                                        {guidelines.map((item, i) => (
                                            <div key={i} className="flex items-center justify-between py-4 border-b border-slate-50 group hover:bg-warm-bg/50 px-4 rounded-xl transition-colors">
                                                ...
                                                <span className="text-sm font-bold text-dark text-right max-w-[200px]">
                                                    {item.value}
                                                </span>
                                            </div>
                                        ))}
                                        ...
                                        <div className="mt-12 p-8 bg-blue-900 text-white rounded-3xl shadow-xl shadow-blue-900/10 relative overflow-hidden group">
                                            ...
                                            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
                                                ...
                                                <div className="shrink-0">
                                                    <ScaleOnHover>
                                                        <Link href="/submission-guidelines/publication-charges" className="px-8 py-4 bg-white text-dark font-bold rounded-full hover:bg-primary/5 transition-all flex items-center gap-2">
