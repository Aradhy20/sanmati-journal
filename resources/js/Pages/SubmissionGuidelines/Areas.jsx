...
export default function AreasOfSubmission() {
    return (
        <MainLayout>
            ...
            <div className="bg-warm-bg min-h-screen font-sans">
                <PageHeader
                    title="Areas of Submission"
                    ...
                    <div className="max-w-6xl mx-auto relative z-10">
                        ...
                        <div className="text-center mb-14">
                            <ScrollReveal variants={revealVariants.fadeUp}>
                                <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary-dark text-xs font-bold uppercase tracking-widest mb-4">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-14">
                                {[
                                    ...
                                    <div key={i} className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm text-center">
                                        <div className="flex items-center justify-center gap-2 text-primary mb-1">{stat.icon}<span className="text-xs font-bold uppercase tracking-wider text-gray-400">{stat.label}</span></div>
                                ...
                                <ScrollReveal key={i} variants={revealVariants.fadeUp} delay={i * 0.04} className="h-full">
                                    <Link href={`/submission-guidelines/areas/${area.slug}`} className="block h-full">
                                        ...
                                        >
                                            ...
                                            <div className="absolute top-4 right-4 px-3 py-1 rounded-full bg-dark text-white text-[10px] font-bold uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-1 group-hover:translate-y-0 z-20 flex items-center gap-1">
                                            ...
                                            <div className="relative z-10">
                                                ...
                                                <div className="flex items-start gap-4 mb-4">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <h3 className="text-base font-bold text-dark mb-1 group-hover:text-primary-dark transition-colors">{area.title}</h3>
                                                        <p className="text-xs text-gray-500 leading-relaxed">{area.desc}</p>
                                                    </div>
                                                    <div className="text-right shrink-0 hidden sm:block">
                                                        <span className="text-lg font-bold text-dark">{area.papers}</span>
                                                        <p className="text-[10px] text-gray-400 uppercase tracking-wider font-bold">Papers</p>
                                                    </div>
                                                </div>
                        ...
                        <ScrollReveal variants={revealVariants.fadeUp} delay={0.3}>
                            <div className="mt-16 relative rounded-2xl overflow-hidden bg-dark text-white shadow-2xl">
                                ...
                                <div className="absolute -top-24 -right-24 w-96 h-96 bg-primary rounded-full blur-[100px] opacity-30 animate-pulse"></div>
                                ...
                                <div className="relative z-10 px-8 py-14 flex flex-col md:flex-row items-center justify-between gap-8 max-w-5xl mx-auto">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 shrink-0">
                                        <Link href="/submission-guidelines/important-info" className="px-6 py-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-full font-bold text-sm text-white hover:bg-white hover:text-dark transition-all duration-300">
                                            Guidelines
                                        </Link>
                                        <a href="mailto:sanmatijournal@gmail.com" className="px-6 py-3 bg-white text-dark rounded-full font-bold text-sm shadow-lg hover:shadow-blue-500/25 hover:scale-105 transition-all duration-300 flex items-center justify-center gap-2">
