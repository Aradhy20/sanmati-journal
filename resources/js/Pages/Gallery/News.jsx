                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 lg:pb-24">
                    <div className="max-w-6xl mx-auto mt-12 grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            <div className="bg-white p-8 md:p-12 rounded-[40px] border border-gray-200 shadow-sm relative overflow-hidden h-fit">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="space-y-8">
                                        {newsItems.map((item, i) => (
                                            <div key={i} className="group p-8 bg-warm-bg rounded-3xl border border-slate-100 hover:bg-white hover:shadow-xl hover:border-primary/20 transition-all duration-300">
                                                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
                                                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/5 text-primary-dark text-[10px] font-black uppercase tracking-widest rounded-full">
                                                        <Calendar className="w-3 h-3" /> {item.date}
                                                    </div>
                                                    <span className="text-xs font-bold text-gray-400 italic">Source: {item.source}</span>
                                                </div>
                                                <h3 className="text-xl font-bold text-dark mb-3 group-hover:text-dark transition-colors font-serif">{item.title}</h3>
                                                <p className="text-gray-600 text-sm leading-relaxed mb-6">{item.excerpt}</p>
                                                <div className="flex items-center gap-2 text-primary text-xs font-bold uppercase tracking-widest cursor-pointer hover:underline transition-all">
                                        ...
                                        <div className="p-10 border-2 border-dashed border-gray-200 rounded-3xl text-center">
                                            <p className="text-gray-400 font-medium italic">More news and announcements coming soon.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="space-y-8">
                            <h2 className="text-2xl font-serif font-bold text-dark flex items-center gap-3 font-serif">
                                <ImageIcon className="text-primary" /> Media Gallery
                            </h2>
                            ...
                            <div className="p-8 bg-dark text-white rounded-[32px] mt-8">
                                <h4 className="font-bold text-lg mb-2">Media Inquiry?</h4>
                                <p className="text-gray-400 text-sm mb-4">For press kits or editorial interviews.</p>
                                <a href="mailto:sanmatijournal@gmail.com" className="w-full py-3 bg-white text-dark font-bold rounded-xl hover:bg-primary/5 transition-all flex items-center justify-center gap-2 text-sm">
