                                    ...
                                    <div className="relative overflow-hidden bg-white rounded-3xl border-2 border-slate-100 shadow-lg hover:shadow-2xl transition-all p-8">
                                        ...
                                        <div className="relative z-10">
                                            <div className="flex justify-between items-start mb-6">
                                                ...
                                                <div className="p-2 rounded-xl bg-warm-bg group-hover:bg-gray-50 transition-all">
                                                    <ArrowUpRight className="w-5 h-5 text-gray-400 group-hover:text-dark/80" />
                                                </div>
                                            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    >
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <span className="text-xs px-3 py-1 bg-primary/10 text-primary-dark rounded-full font-black uppercase">Live</span>
                        </div>
                            ...
                            {[1, 2, 3].map((item) => (
                                ...
                                >
                                    ...
                                    <div className="flex-grow">
                                        <p className="font-bold text-dark group-hover:text-primary transition-colors">System check complete</p>
                            ...
                            {quickActions.map((action, i) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                    >
                                        <Link href={action.href} className="flex items-center gap-4 p-5 bg-warm-bg hover:bg-gradient-to-r hover:from-slate-50 hover:to-blue-50 rounded-2xl transition-all group border-2 border-transparent hover:border-primary/20">
                                            <div className={`p-3 bg-gradient-to-br ${action.gradient} rounded-xl shadow-lg group-hover:shadow-xl transition-all`}>
                                                <Icon className="w-6 h-6 text-white" />
                                            </div>
                                            <span className="font-bold text-dark/80 group-hover:text-dark flex-grow">{action.label}</span>
                                            <ArrowUpRight className="w-5 h-5 text-slate-300 group-hover:text-primary transition-colors" />
                                        </Link>
                                    </motion.div>
                                );
