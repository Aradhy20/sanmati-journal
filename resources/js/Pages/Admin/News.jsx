        ...
        <AdminLayout>
            <div className="space-y-8">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-xl md:text-2xl lg:text-3xl font-serif font-bold text-dark mb-2">News & Announcements</h1>
                        <p className="text-gray-500 text-sm">Manage the news ticker and site-wide alerts.</p>
                    </div>
                </div>
                ...
                <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm">
                    <h3 className="text-lg font-bold text-dark mb-6 flex items-center gap-2">
                        <Plus className="text-primary w-5 h-5" /> Create New Announcement
                    </h3>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-warm-bg/50 border-b border-slate-100">
                                    ...
                                    <th className="px-8 py-5 text-xs font-black text-gray-400 uppercase tracking-widest">Content</th>
                                    ...
                                    news.map((item) => (
                                        <tr key={item.id} className="hover:bg-warm-bg/50 transition-colors group">
                                            ...
                                            <td className="px-8 py-6 max-w-xl">
                                                <p className="font-bold text-dark leading-relaxed">{item.content}</p>
                                            </td>
                                            <td className="px-8 py-6">
                                                <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest border ${item.is_active ? "bg-emerald-50 text-emerald-700 border-emerald-100" : "bg-warm-bg text-gray-400 border-gray-200"
                                                    }`}>
