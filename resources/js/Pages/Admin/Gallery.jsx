            ...
            <div className="space-y-8">
                ...
                <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm">
                    <h3 className="text-lg font-bold text-dark mb-6 flex items-center gap-2">
                        <Plus className="text-primary w-5 h-5" /> Add New Photo
                    </h3>
                    <form onSubmit={submit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Upload Photo</label>
                                <input
                                    type="file"
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Caption</label>
                            <input
                                value={data.caption}
                    ...
                    {gallery.length === 0 ? (
                        ...
                        gallery.map((item) => (
                            <div key={item.id} className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden group hover:shadow-xl transition-all">
                                ...
                                <div className="p-5">
                                    <p className="text-sm font-medium text-dark/80 line-clamp-2 leading-relaxed">
