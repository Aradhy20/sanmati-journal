            ...
            <div className="space-y-8">
                ...
                <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm">
                    <h3 className="text-lg font-bold text-dark mb-6 flex items-center gap-2">
                        <UserPlus className="text-primary w-5 h-5" /> New Board Member
                    </h3>
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Qualifications</label>
                                <input
                            ...
                            <div className="space-y-2">
                                <label className="text-xs font-black text-gray-400 uppercase tracking-widest ml-1">Affiliation / Experience</label>
                                <input
                            ...
                            <div key={member.id} className="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden hover:shadow-xl transition-all group">
                                <div className="p-8">
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <h4 className="text-xl font-bold text-dark group-hover:text-dark transition-colors">{member.name}</h4>
