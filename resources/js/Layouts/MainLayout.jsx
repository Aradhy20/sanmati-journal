    ...
    return (
        <div className="min-h-screen flex flex-col bg-slate-50 font-sans antialiased relative overflow-x-hidden transition-colors duration-300">
            ...
            <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
                <GlassyBlob className="top-[-10%] left-[-10%] w-[500px] h-[500px]" color="bg-blue-400" />
                <GlassyBlob className="bottom-[-10%] right-[-10%] w-[600px] h-[600px]" color="bg-indigo-300" />
                <GlassyBlob className="top-[40%] right-[-5%] w-[400px] h-[400px]" color="bg-purple-200" />
            </div>
