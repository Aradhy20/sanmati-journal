...
const Navbar = () => {
    ...
    return (
        <>
            {/* Top Info Bar - Professional & Clean */}
            <div className="bg-dark/95 backdrop-blur-md text-white/60 text-[11px] font-medium hidden lg:block border-b border-white/5">
                <div className="max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between h-9">
                    <div className="flex items-center gap-8">
                        <a href="mailto:sanmatijournal@gmail.com" className="flex items-center gap-2 hover:text-secondary-light transition-colors group">
                            <Mail className="w-3.5 h-3.5 text-secondary" /> 
                            <span className="group-hover:translate-x-0.5 transition-transform">sanmatijournal@gmail.com</span>
                        </a>
                        <a href="tel:+918979782949" className="flex items-center gap-2 hover:text-secondary-light transition-colors group">
                            <Phone className="w-3.5 h-3.5 text-secondary" /> 
                            <span className="group-hover:translate-x-0.5 transition-transform">+91 8979782949</span>
                        </a>
                    </div>
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-2">
                            <MapPin className="w-3.5 h-3.5 text-secondary/70" />
                            <span>TMU Campus, Moradabad (U.P)</span>
                        </div>
                        <div className="h-3 w-[1px] bg-white/10" />
                        <span className="text-secondary font-bold tracking-widest">ISSN: 3108-1819</span>
                    </div>
                </div>
            </div>

            {/* Main Navbar - Premium Glassmorphism */}
            <nav className={`sticky top-0 w-full z-50 transition-all duration-500 ease-[0.22,1,0.36,1] ${scrolled ? 'bg-white/80 backdrop-blur-2xl shadow-sm border-b border-gray-100/50 py-1' : 'bg-white/95 border-b border-transparent py-4'}`}>
