            ...
            <DynamicCard gradient={gradient} className="h-full p-8 group">
                <div className="relative z-10">
                    <div className="flex justify-between items-start mb-6">
                        ...
                        <div className="p-2 rounded-full bg-warm-bg group-hover:bg-white/80 transition-colors">
                            <TrendingUp className={`w-5 h-5 text-${colorClass}-500`} />
                        </div>
                    </div>

                    <div className="flex items-baseline gap-1">
                        <span className="text-5xl font-black text-dark tracking-tight">
                            {display}
                        </span>
                    ...
                    <p className="mt-4 text-gray-500 font-bold uppercase tracking-widest text-xs group-hover:text-dark/80 transition-colors">
                        {label}
                    </p>
                </div>
            </DynamicCard>
    ...
    return (
        <section className="py-24 relative overflow-hidden">
            <div className="absolute inset-0 pointer-events-none">
                ...
                <GlassyBlob className="top-0 left-1/4 w-96 h-96" color="bg-primary/10" />
