...
const ProcessTimeline = () => {
    return (
        <section className="py-24 bg-white relative overflow-hidden transition-colors duration-300">
            ...
            <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-[600px] h-[600px] bg-primary/5 rounded-full blur-[120px] opacity-60" />

            <div className="container-custom relative z-10 mx-auto px-4 max-w-7xl">
                <ScrollReveal>
                    <div className="text-center mb-20">
                        <span className="text-primary font-bold tracking-[0.2em] text-xs uppercase mb-3 block">Publication Lifecycle</span>
                ...
                <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="hidden lg:block absolute top-[44px] left-[10%] right-[10%] h-[2px] bg-gray-50 -z-10">
                        <motion.div
                        ...
                        <ScrollReveal key={index} delay={index * 0.2}>
                            <div className="group relative flex flex-col items-center text-center">
                                ...
                                <div className={`relative w-20 h-20 rounded-2xl ${step.color} flex items-center justify-center text-white shadow-lg mb-8 transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 group-hover:shadow-[0_20px_50px_rgba(59,130,246,0.3)]`}>
                                    ...
                                    {/* Step Number Badge */}
                                    <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-white text-dark text-xs font-bold flex items-center justify-center shadow-md border border-slate-100">
                                        0{index + 1}
                                    </div>
                                </div>
