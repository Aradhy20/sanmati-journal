    ...
    return (
        <div className="border-b border-gray-200 last:border-0">
            ...
            >
                ...
                <span className={`shrink-0 w-8 h-8 rounded-full flex items-center justify-center border transition-all duration-300 ${isOpen ? 'bg-primary border-primary text-white rotate-180' : 'bg-white border-gray-200 text-gray-500 group-hover:border-primary group-hover:text-primary'}`}>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <ScrollReveal>
                    <div className="text-center mb-16">
                        <span className="inline-flex items-center gap-2 px-3 py-1 bg-primary/5 text-purple-700 rounded-full text-sm font-bold uppercase tracking-widest mb-4">
                            <HelpCircle className="w-4 h-4" /> Need Help?
                        </span>
                        <h2 className="text-4xl font-serif font-bold text-dark mb-4">Frequently Asked Questions</h2>
