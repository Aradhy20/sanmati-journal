...
Route::get('/gallery/journal-news', [JournalController::class, 'galleryNews'])->name('gallery.news');
...
Route::post('/contact', [JournalController::class, 'contactStore'])->name('contact.store');
...
// Admin Routes (Simplified, should eventually be protected by auth middleware)
